...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or "سمايل"
SudosS = {996435622,5226430730}
...
JoinChannel = true
local url , res = https.request('https://api.telegram.org/bot/getchatmember?chat_id=@EUUUJ&user_id='..msg.sender.user_id)
...
return {
by   = '\n*𖡼⁞بواسطه : *'..UserInfousername..'\n'..TextMsg,
i   = '\n*𖡼⁞المستخدم : *'..UserInfousername..'\n'..TextMsg,
yu    = '\n*𖡼⁞عزيزي : *'..UserInfousername..'\n'..TextMsg
}
end
function getJson(R)  
...
File:close()
bot.sendDocument(R,0,'./'..bot_id..'.json', '𖡼⁞تم جلب النسخه الاحتياطيه', 'md')
end
...
return bot.answerCallbackQuery(data.id,"𖡦عذرا الامر لا يخصك ", true)
end
if Type == "st" then  
...
t = "𖡦قائمه "..ty.." ."
if #Info_ == 0 then
return bot.answerCallbackQuery(data.id,"𖡦قائمه "..ty.." فارغه .", true)
end  
...
bot.editMessageText(chat_id,msg_id,"* 𖡼⁞تحوي قائمه المنع على\n𖡼⁞الصور ( "..Photo.." )\n𖡼⁞الكلمات ( "..Text.." )\n𖡼⁞الملصقات ( "..Sticker.." )\n𖡼⁞المتحركات ( "..Animation.." )\n𖡼⁞اضغط على القائمه المراد حذفها*", 'md', true, false, reply_markup)
...
type = 'inline',
data = {
{{text = '𖡦⥁𝐓𝐄𝐀𝐌 𝐑𝐎𝐁𝐋𝐗',url="t.me/EUUUJ"}},
}
}
if redis:get(bot_id..'Set:array'..user_id..':'..chat_id) == 'true1' then
redis:del(bot_id..'Set:array'..user_id..':'..chat_id)
bot.editMessageText(chat_id,msg_id,"*𖡼⁞تم حفظ الردود بنجاح*", 'md', true, false, reply_markup)
else
bot.editMessageText(chat_id,msg_id," *𖡼⁞تم تنفيذ الامر سابقا*", 'md', true, false, reply_markup)
end
end
if Text and Text:match("^Sur_(.*)_(.*)") then
local infomsg = {Text:match("^Sur_(.*)_(.*)")}
if tonumber(data.sender_user_id) ~= tonumber(infomsg[1]) then  
bot.answerCallbackQuery(data.id, "𖡦الامر لا يخصك", true)
return false
end   
...
bot.editMessageText(chat_id,msg_id,"* 𖡼⁞لا يمتلك البوت صلاحيه حظر الاعضاء*", 'md', true, false, reply_markup)
return false
end   
if not Isrank(data.sender_user_id,chat_id) then
t = "*𖡼⁞لا يمكن للبوت حظر "..Get_Rank(data.sender_user_id,chat_id).."*"
else
t = "*𖡼⁞تم طردك بنجاح*"
...
bot.editMessageText(chat_id,msg_id,"*𖡼⁞تم الغاء العمليه الطرد بنجاح*", 'md', true, false, reply_markup)
end
end
...
t = "*𖡦اوامر الحمايه اتبع مايلي\n *ٴ─━─━─━─×─━─━─━─ *\n𖡦قفل ، فتح ← الامر\n𖡦تستطيع قفل حمايه كما يلي\n𖡦{ بالتقيد ، بالطرد ، بالكتم ، بالتقييد }\n *ٴ─━─━─━─×─━─━─━─ *\n𖡦تاك\n𖡦القناه\n𖡦الصور\n𖡦الرابط\n𖡦الفشار\n𖡦الموقع\n𖡦التكرار\n𖡦الفيديو\n𖡦الدخول\n𖡦الاضافه\n𖡦الاغاني\n𖡦الصوت\n𖡦الملفات\n𖡦الرسائل\n𖡦الدردشه\n𖡦الجهات\n𖡦السيلفي\n𖡦التثبيت\n𖡦الشارحه\n𖡦الكلايش\n𖡦البوتات\n𖡦التوجيه\n𖡦التعديل\n𖡦الانلاين\n𖡦المعرفات\n𖡦الكيبورد\n𖡦الفارسيه\n𖡦الانكليزيه\n𖡦الاستفتاء\n𖡦الملصقات\n𖡦الاشعارات\n𖡦الماركداون\n𖡦المتحركات*"
elseif infomsg[2] == '2' then
reply_markup = reply_markup
t = "*𖡦اعدادات المجموعه \n *ٴ─━─━─━─×─━─━─━─ *\n𖡦( الترحيب ) \n𖡦( مسح الرتب ) \n𖡦( الغاء التثبيت ) \n𖡦( فحص البوت ) \n𖡦( تعين الرابط ) \n𖡦( مسح الرابط ) \n𖡦( تغيير الايدي ) \n𖡦( تعين الايدي ) \n𖡦( مسح الايدي ) \n𖡦( مسح الترحيب ) \n𖡦( صورتي ) \n𖡦( تغيير اسم المجموعه ) \n𖡦( تعين قوانين ) \n𖡦( تغيير الوصف ) \n𖡦( مسح القوانين ) \n𖡦( مسح الرابط ) \n𖡦( تنظيف التعديل ) \n𖡦( تنظيف الميديا ) \n𖡦( مسح الرابط ) \n𖡦( رفع الادمنيه ) \n𖡦( تعين ترحيب ) \n𖡦( الترحيب ) \n𖡦( الالعاب الاحترافيه ) \n𖡦( المجموعه ) *"
elseif infomsg[2] == '3' then
reply_markup = reply_markup
t = "*𖡦اوامر التفعيل والتعطيل \n𖡦تفعيل/تعطيل الامر اسفل  \n *ٴ─━─━─━─×─━─━─━─ *\n𖡦( اوامر التسليه ) \n𖡦( الالعاب الاحترافيه ) \n𖡦( الطرد ) \n𖡦( الحظر ) \n𖡦( الرفع ) \n𖡦( المميزات ) \n𖡦( المسح التلقائي ) \n𖡦( ٴall ) \n𖡦( منو ضافني ) \n𖡦( تفعيل الردود ) \n𖡦( الايدي بالصوره ) \n𖡦( الايدي ) \n𖡦( التنظيف ) \n𖡦( الترحيب ) \n𖡦( الرابط ) \n𖡦( البايو ) \n𖡦( صورتي ) \n𖡦( الالعاب ) *"
...
{{text = "ᴘʀᴏᴛᴇᴄᴛɪᴏɴ¹" ,data="Amr_"..data.sender_user_id.."_1"},{text = "ѕᴇᴛᴛɪɴɢѕ²",data="Amr_"..data.sender_user_id.."_2"}},
{{text = "ᴏᴘᴇɴ /ᴄʟᴏѕᴇ³",data="Amr_"..data.sender_user_id.."_3"},{text ="ᴏᴛʜᴇʀѕ⁴",data="Amr_"..data.sender_user_id.."_4"}},
{{text = '⥁𝐓𝐄𝐀𝐌 𝐑𝐎𝐁𝐋𝐗 .',url="t.me/EUUUJ"}},
}
}
t = "*𖡼⁞قائمه الاوامر \n *ٴ─━─━─━─×─━─━─━─ *\n𖡼⁞م1 ( اوامر الحمايه ) \n𖡼⁞م2 ( اوامر إعدادات المجموعه ) \n𖡼⁞م3 ( اوامر القفل والفتح ) \n𖡼⁞م4 ( اوامر اخرى ) *"
end
bot.editMessageText(chat_id,msg_id,t, 'md', true, false, reply_markup)
end
----------------------------------------------------------------------------------------------------
...
bot.editMessageText(chat_id,msg_id,"*𖡼⁞اعدادات المجموعه *", 'md', true, false, reply_markup)
end
...
type = 'inline',data = {
	{{text = '𖡦الاحصائيات',data="indfo"}},
	{{text = '𖡦تغيير المطور الاساسي',data="EditDevbot"}},
{{text = '𖡦تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "اينو"),data="delnamebot"}},
{{text = '𖡦تغيير كليشه ستارت',data="addstarttxt"},{text ="𖡦حذف كليشه ستارت",data="Deltxtstart"}},
{{text = '𖡦تنظيف المشتركين',data="clenMsh"},{text ="𖡦تنظيف المجموعات",data="clenMg"}},
...
{{text = '𖡦الاشتراك الاجباري',data="chatmem"},{text = '𖡦الاذاعه',data="sendtomem"}},
{{text = '𖡦مسح المطورين',data="deldev"},{text ="𖡦مسح الثانويين",data="delpor"}},
{{text = '𖡦المطورين',data="lsdev"},{text ="𖡦الثانويين",data="lspor"}},
{{text = '𖡦مسح المكتومين عام',data="delmu"},{text ="𖡦مسح المحظورين عام",data="delbnal"}},
{{text = '𖡦المكتومين عام',data="lsmu"},{text ="𖡦المحظورين عام",data="lsbnal"}},
{{text = '𖡦جلب نسخه احتياطيه',data="GetfJson"},{text = '𖡦رفع نسخه احتياطيه',data="UpfJson"}},
                {{text = '𖡦تحديث',data="UpBot"},{text = '𖡦تحديث السورس',data="UpSu"}},
{{text = '𖡦⥁𝐓𝐄𝐀𝐌 𝐑𝐎𝐁𝐋𝐗',url="t.me/EUUUJ"}},
}
}
bot.editMessageText(chat_id,msg_id,"*𖡼⁞اهلا بك في قائمه الاوامر : العلامه ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس*", 'md', true, false, reply_dev)
end
...
bot.editMessageText(chat_id,msg_id,"*𖡼⁞قم بأعاده ارسال الملف الخاص بالنسخه*", 'md', true, false, reply_markup)
redis:set(bot_id..":set:"..chat_id..":UpfJson",true) 
end
if Text == "GetfJson" then
bot.answerCallbackQuery(data.id, "𖡼⁞جار ارسال النسخه", true)
getJson(chat_id)
dofile("start.lua")
end
if Text == "Delch" then
if not redis:get(bot_id..":TheCh") then
bot.answerCallbackQuery(data.id, "𖡼⁞لم يتم وضع اشتراك في البوت", true)
return false
end
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
...
bot.editMessageText(chat_id,msg_id,"*𖡼⁞تم حذف البوت بنجاح*", 'md', true, false, reply_markup)
...
bot.editMessageText(chat_id,msg_id,"*𖡼⁞قم برفع البوت ادمن في قناتك ثم قم بأرسل توجيه من القناه الى البوت*", 'md', true, false, reply_markup)
...
bot.editMessageText(chat_id,msg_id,"*𖡼⁞الاشتراك الاجباري على القناه اسفل :*", 'md', true, false, reply_dev)
end
if Text == "indfo" then
...
bot.editMessageText(chat_id,msg_id,"*𖡼⁞اهلا بك في قسم الاحصائيات \n *ٴ─━─━─━─×─━─━─━─ *\n𖡼⁞عدد المشتركين ( "..user_id.." ) عضو \n𖡼⁞عدد المجموعات ( "..Groups.." ) مجموعه *", 'md', true, false, reply_dev)
end
if Text == "chatmem" then
reply_dev = bot.replyMarkup{
type = 'inline',data = {
{{text = '𖡦اضف اشتراك',data="addCh"},{text ="𖡦حذف اشتراك",data="Delch"}},
{{text = '𖡦الاشتراك',data="TheCh"}},
{{text = '𖡦رجوع',data="Can"}},
}
}
bot.editMessageText(chat_id,msg_id,"*𖡼⁞اهلا بك في لوحه اوامر الاشتراك الاجباري*", 'md', true, false, reply_dev)
end
...
bot.editMessageText(chat_id,msg_id,"*𖡼⁞قم الان بأرسل ايدي المطور الجديد*", 'md', true, false, reply_markup)
...
bot.editMessageText(chat_id,msg_id,"*𖡼⁞قم الان بأرسل كليشه ستارت الجديده*", 'md', true, false, reply_markup)
...
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "𖡦لا يوجد محظورين بالبوت", true)
return false
end  
...
if Text == 'lsmu' then
t = '\n*𖡦قائمه المكتومين عام  \n   ٴ─━─━─━─×─━─━─━─ *\n'
local Info_ = redis:smembers(bot_id..":bot:silent") 
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "𖡦لا يوجد مكتومين بالبوت", true)
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
...
local Info_ = redis:smembers(bot_id..":bot:Ban")
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "𖡦لا يوجد محظورين في البوت", true)
return false
end  
redis:del(bot_id..":bot:Ban")
bot.answerCallbackQuery(data.id, "𖡦تم مسح المحظورين بنجاح", true)
end
if Text == "delmu" then
local Info_ = redis:smembers(bot_id..":bot:silent")
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "𖡦لا يوجد مكتومين في البوت ", true)
return false
end  
redis:del(bot_id..":bot:silent")
bot.answerCallbackQuery(data.id, "𖡦تم مسح المكتومين بنجاح", true)
end
if Text == 'lspor' then
t = '\n*𖡦قائمه الثانويين  \n   ٴ─━─━─━─×─━─━─━─ *\n'
local Info_ = redis:smembers(bot_id..":Status:programmer") 
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "𖡦لا يوجد ثانويين بالبوت", true)
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
...
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "𖡦لا يوجد مطورين بالبوت", true)
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
...
os.execute('curl -s https://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@raw.githubusercontent.com/PPFFP/TEAMROBLX/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
bot.answerCallbackQuery(data.id, "𖡦تم تحديث البوت", true)
dofile("start.lua")
end
...
bot.answerCallbackQuery(data.id, "𖡦تم حذف اسم البوت بنجاح", true)
end
...
bot.editMessageText(chat_id,msg_id,"*𖡼⁞قم الان بأرسل اسم البوت الجديد*", 'md', true, false, reply_markup)
redis:set(bot_id..":set:"..chat_id..":namebot",true) 
end
if Text == "delpor" then
local Info_ = redis:smembers(bot_id..":Status:programmer") 
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "𖡦لا يوجد ثانويين في البوت", true)
return false
end
redis:del(bot_id..":Status:programmer") 
bot.answerCallbackQuery(data.id, "𖡦تم مسح الثانويين بنجاح", true)
end
if Text == "deldev" then
local Info_ = redis:smembers(bot_id..":Status:developer") 
if #Info_ == 0 then
bot.answerCallbackQuery(data.id, "𖡦لا يوجد مطورين في البوت", true)
return false
end
redis:del(bot_id..":Status:developer") 
bot.answerCallbackQuery(data.id, "𖡦تم مسح المطورين بنجاح", true)
end
...
return bot.editMessageText(chat_id,msg_id,'*𖡼⁞العدد الكلي ( '..#list..' )\n𖡼⁞تم العثور على ( '..x..' ) من المشتركين الوهميين*', 'md', true, false, reply_dev)
else
return bot.editMessageText(chat_id,msg_id,'*𖡼⁞العدد الكلي ( '..#list.." )\n𖡼⁞لم يتم العثور على وهميين*", 'md', true, false, reply_dev)
end
end
if Text == "clenMg" then
...
x = x + 1
bot.sendText(Get_Chat.id,0,'*𖡼⁞البوت ليس ادمن في المجموعه*',"md")
...
return bot.editMessageText(chat_id,msg_id,'*𖡼⁞العدد الكلي ( '..#list..' )\n𖡼⁞تم العثور على ( '..x..' ) من المجموعات الوهميه*', 'md', true, false, reply_dev)
else
return bot.editMessageText(chat_id,msg_id,'*𖡼⁞العدد الكلي ( '..#list.." )\n𖡼⁞لم يتم العثور على مجموعات وهميه*", 'md', true, false, reply_dev)
end
end
if Text == "sendtomem" then
reply_dev = bot.replyMarkup{
type = 'inline',data = {
{{text = '𖡦رساله للكل',data="AtSer_Tall"},{text ="𖡦توجيه للكل",data="AtSer_Fall"}},
{{text = '𖡦رساله للمجموعات',data="AtSer_Tgr"},{text ="𖡦توجيه للمجموعات",data="AtSer_Fgr"}},
{{text = '𖡦رساله للاعضاء',data="AtSer_Tme"},{text ="𖡦توجيه للاعضاء",data="AtSer_Fme"}},
{{text = '𖡦رجوع',data="Can"}},
}
}
bot.editMessageText(chat_id,msg_id,"*𖡼⁞اوامر الاذاعه الخاصه بالبوت*", 'md', true, false, reply_dev)
end
...
reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '𖡦الغاء',data="Can"}},
}
}
redis:setex(bot_id..":set:"..chat_id..":send",600,iny)  
bot.editMessageText(chat_id,msg_id,"*𖡼⁞قم الان بأرسال الرساله *", 'md', true, false, reply_markup)
end
----------------------------------------------------------------------------------------------------
end
end
...
if TrS == "Fall" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞يتم توجيه الرساله الى ( "..#lis.." عضو ) و ( "..#list.." مجموعه ) *","md",true)      
for k,v in pairs(list) do
...
redis:del(bot_id..":count:true") 
elseif TrS == "Fme" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞يتم توجيه الرساله الى ( "..#lis.." عضو ) *","md",true)      
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞يتم ارسال الرساله الى ( "..#lis.." عضو ) و ( "..#list.." مجموعه ) *","md",true)      
for k,v in pairs(list) do
...
redis:del(bot_id..":count:true") 
elseif TrS == "Tgr" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞يتم ارسال الرساله الى ( "..#list.." مجموعه ) *","md",true)      
for k,v in pairs(list) do
local FedMsg = bot.forwardMessages(v, msg.chat_id, msg.id,0,0,true,true,false)
if FedMsg then
redis:incr(bot_id..":count:true") 
...
redis:del(bot_id..":count:true") 
elseif TrS == "Tme" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞يتم ارسال الرساله الى ( "..#lis.." عضو ) *","md",true)      
for k,v in pairs(lis) do
local FedMsg = bot.forwardMessages(v, msg.chat_id, msg.id,0,0,true,true,false)
if FedMsg then
redis:incr(bot_id..":count:true") 
...
return bot.sendText(msg.chat_id,msg.id,'*𖡼⁞عذرا الملف هذا ليس للبوت*')
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم رفع النسخه بنجاح*","md")
end     
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞عذرا يجب عليك ارسل توجيه من قناه فقط*","md")
return false
end     
sm = bot.getChatMember(id_chat,bot_id)
if sm.status.luatele == "chatMemberStatusAdministrator" then
redis:set(bot_id..":TheCh",id_chat) 
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم حفظ القناه بنجاح *","md", true)
else
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞البوت ليس مشرف بالقناه*","md", true)
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم تغيير المطور الاساسي بنجاح*","md", true)
dofile("start.lua")
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞اهلا بك في قائمه الاوامر : العلامه ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس*","md", true, false, false, false, reply_dev)
end
end
...
if text == "/start" then 
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞اهلا بك في قائمه الاوامر : العلامه ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس*","md", true, false, false, false, bot.replyMarkup{
type = 'inline',data = {
	{{text = '𖡦الاحصائيات',data="indfo"}},
	{{text = '𖡦تغيير المطور الاساسي',data="EditDevbot"}},
{{text = '𖡦تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "اينو"),data="delnamebot"}},
...
bot.sendText(sudoid,0,Reply_Status(msg.sender.user_id,"*𖡼⁞قام بدخول الى البوت عدد اعضاء البوت الان ( "..scarduser_id.." ) .*").i,"md",true)
end
end
redis:sadd(bot_id..":user_id",msg.sender.user_id)  
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '𖡦اضفني الى مجموعتك',url="https://t.me/"..bot.getMe().username.."?startgroup=new"}},
{{text = '𖡦⥁𝐓𝐄𝐀𝐌 𝐑𝐎𝐁𝐋𝐗',url="t.me/EUUUJ"}},
}
}
...
r ="*𖡼⁞اهلا بك في بوت الحمايه  \n𖡼⁞وضيفتي حمايه المجموعات من السبام والتفليش والخ..\n𖡼⁞لتفعيل البوت ارسل كلمه *تفعيل"
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,'*𖡼⁞تم ارسال رسالتك الى المطور*').yu,"md",true)
...
bot.sendText(IdSudo,0,Reply_Status(msg.sender.user_id,'*𖡼⁞قام بارسال الملصق*').i,"md",true)  
return false
end
else
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,'*𖡼⁞انت محظور من البوت*').yu,"md",true)  
end
end
end
end
...
if text == 'حظر' then
bot.sendText(msg.chat_id,0,Reply_Status(id_user,'*𖡼⁞تم حظره بنجاح*').i,"md",true)
redis:sadd(bot_id.."banTo",id_user)  
return false  
end 
if text =='الغاء الحظر' then
bot.sendText(msg.chat_id,0,Reply_Status(id_user,'*𖡼⁞تم الغاء حظره بنجاح*').i,"md",true)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(id_user,'*𖡼⁞تم ارسال رسالتك اليه*').i,"md",true)  
end
end
end
----------------------------------------------------------------------------------------------------
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞تم قفل التوجيه في المجموعه*").yu,"md",true)  
end
end
...
bot.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞قام بالتكرار في المجموعه وتم حظره*").yu,"md",true)
...
bot.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞قام بالتكرار في المجموعه وتم تقييده*").yu,"md",true)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞قام بالتكرار في المجموعه وتم كتمه*").yu,"md",true)  
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞التثبيت معطل من قبل المدراء*","md",true)
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم منع الكلمه سابقا*","md",true)
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم منع الملصق سابقا*","md",true)
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم منع المتحركه سابقا*","md",true)
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم منع الصوره سابقا*","md",true)
return false
end
redis:sadd(bot_id.."mn:content:Photo"..msg.chat_id,msg.content.photo.sizes[1].photo.remote.unique_id)  
ty = "الصوره"
end
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم منع "..ty.." بنجاح*","md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم حفظ الرد بنجاح*","md",true)  
return false
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم المغادره من المجموعه*","md",true)
...
if programmer(msg) then  
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم تحديث السورس الى الاصدار الجديد*","md",true)
os.execute('rm -rf start.lua')
...
if text == "تحديث" then
if programmer(msg) then  
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم تحديث ملفات البوت*","md",true)
dofile("start.lua")
end 
end
if Constructor(msg) then
if text == ("مسح ردود المدير") then
ext = "*𖡼⁞تم مسح قائمه ردود المدير*"
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم حفظ الامر بنجاح*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞قم الان بأرسال الامر الجديد*","md",true)  
return false
end
end
if text == "حذف امر" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞قم بأرسال الامر الجديد الان*","md",true)
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Command:del",true)
end
if text == "اضف امر" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞قم الان بأرسال الامر القديم*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞قم بارسال الرد الذي تريد اضافته*","md",true)  
return false
end
if text == "اضف رد" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞ارسل الان الكلمه لاضافتها في الردود*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم حذف الرد بنجاح*","md",true)  
end
end
if text == "حذف رد" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞ارسل الان الكلمه لحذفها من الردود*","md",true)
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Rp:del",true)
end
if text == ("ردود المدير") then
local list = redis:smembers(bot_id.."List:Rp:content"..msg.chat_id)
ext = "𖡼⁞قائمه ردود المدير\n  ٴ─━─━─━─×─━─━─━─ \n"
for k,v in pairs(list) do
...
if #list == 0 then
ext = "𖡼⁞عذرا لا يوجد ردود للمدير في المجموعه"
end
bot.sendText(msg.chat_id,msg.id,"["..ext.."]","md",true)  
end
----------------------------------------------------------------------------------------------------
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم مسح الاوامر بنجاح*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞ارسل الكلمه الرد الذي تريد اضافتها*","md",true)  
return false
end
end
...
return bot.sendText(msg.chat_id,msg.id,' *𖡼⁞تم حفظ الرد يمكنك ارسال اخر او اكمال العمليه من خلال الزر اسفل ✅*',"md",true, false, false, false, reply_ad)
end
if text and text:match("^(.*)$") then
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞لا يوجد رد متعدد* ","md",true)  
return false
end
redis:srem(bot_id.."Add:Rd:array:Text"..gery..msg.chat_id,text)
bot.sendText(msg.chat_id,msg.id,' *𖡼⁞تم حذفه بنجاح* ',"md",true)  
end
end
if text and text:match("^(.*)$") then
...
bot.sendText(msg.chat_id,msg.id,' *𖡼⁞قم بارسال الرد الذي تريد حذفه منه* ',"md",true)  
return false
end
end
if text == "حذف رد من متعدد" and Owner(msg) then
redis:set(bot_id.."Set:array:Ssd"..msg.sender.user_id..":"..msg.chat_id,"delrd")
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞ارسل الكلمه الرد الاصليه*","md",true)  
return false
end
if text and text:match("^(.*)$") then
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم حذف الرد المتعدد بنجاح*","md",true)  
return false
end
end
...
t = Reply_Status(msg.sender.user_id,"\n *ٴ─━─━─━─×─━─━─━─ *\n*𖡼⁞قائمه الردود المتعدده*\n  *ٴ─━─━─━─×─━─━─━─ *\n").yu
for k,v in pairs(list) do
t = t..""..k..">> ("..v..") » {رساله}\n"
end
if #list == 0 then
t = "*𖡼⁞لا يوجد ردود متعدده*"
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم مسح الردود المتعدده*","md",true)  
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '⌁︙ ⥁𝐓𝐄𝐀𝐌 𝐑𝐎𝐁𝐋𝐗', url = 't.me/EUUUJ'}, },}}
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم ترتيب الاوامر بالشكل التالي \n𖡼⁞تعطيل الايدي بالصوره ︙تعط\n𖡼⁞تفعيل الايدي بالصوره ︙تفع\n𖡼⁞رفع منشئ الاساسي ︙اس\n𖡼⁞رفع مطور ثانوي ︙ثانوي\n𖡼⁞مسح المكتومين ︙،،\n𖡼⁞مسح سحكاتي ︙سح\n𖡼⁞مسح رسائلي ︙رس\n𖡼⁞تنزيل الكل ︙تك\n𖡼⁞ردود المدير ︙رر\n𖡼⁞رفع منشى ︙من\n𖡼⁞رفع مطور ︙مط\n𖡼⁞رفع مدير ︙مد\n𖡼⁞رفع ادمن ︙اد\n𖡼⁞رفع مميز ︙م\n𖡼⁞اضف رد ︙رد\n𖡼⁞غنيلي ︙غ\n𖡼⁞الرابط ︙ر\n𖡼⁞ايدي ︙ا*","md",true)  
end
end
if Owner(msg) then
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم ترتيب الاوامر بالشكل التالي \n𖡼⁞رفع\n𖡼⁞حاته-حات- صاك-صاكه-ملك-ملكه-مبرمج-مطي-طلي-خروف-جلب-جلبه-حصان-قرد-مرتي-زوجي *","md",true)  
end
end
if text == "اوامر التسليه" or text == "اوامر التسلية" then    
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞ترتيب اوامر التسليه\n𖡼⁞بوسه\n𖡼⁞بوسها\n𖡼⁞مصه\n𖡼⁞مصها\n𖡼⁞كت\n𖡼⁞رزله\n𖡼⁞هينه\n𖡼⁞رزلها\n𖡼⁞هينها\n𖡼⁞لك رزله\n𖡼⁞لك هينه\n𖡼⁞تفله\n𖡼⁞لك تفله\n𖡼⁞شنو رئيك بهذا\n𖡼⁞شنو رئيك بهاي*","md",true)
end
if Administrator(msg) then
if text == 'مسح البوتات' or text == 'حذف البوتات' or text == 'طرد البوتات' then            
if GetInfoBot(msg).BanUser == false then
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞البوت لا يمتلك صلاحيه حظر الاعضاء* ',"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم حظر ( "..i.." ) من البوتات في المجموعه*","md",true)  
end
if text == 'البوتات' then  
local Info = bot.searchChatMembers(msg.chat_id, "*", 200)
local members = Info.members
ls = "*𖡼⁞قائمه البوتات في المجموعه\n  *ٴ─━─━─━─×─━─━─━─ *\n𖡼⁞العلامه 《 *★ * 》 تدل على ان البوت مشرف*\n *ٴ─━─━─━─×─━─━─━─ *\n"
i = 0
for k, v in pairs(members) do
UserInfo = bot.getUser(v.member_id.user_id) 
if UserInfo.type.luatele == "userTypeBot" then 
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞قائمه الاوامر\n *ٴ─━─━─━─×─━─━─━─ *\n𖡼⁞م1 ( اوامر الحمايه \n𖡼⁞م2 ( اوامر إعدادات المجموعه )\n𖡼⁞م3 ( اوامر القفل والفتح )\n𖡼⁞م4 ( اوامر اخرى )*","md", true, false, false, false, reply_markup)
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦اوامر الحمايه اتبع مايلي .\n *ٴ─━─━─━─×─━─━─━─ *\n𖡦قفل ، فتح ← الامر .\n← تستطيع قفل حمايه كما يلي .\n← { بالتقيد ، بالطرد ، بالكتم ، بالتقييد }\n *ٴ─━─━─━─×─━─━─━─ *\n𖡦تاك .\n𖡦القناه .\n𖡦الصور .\n𖡦الرابط .\n𖡦الفشار .\n𖡦الموقع .\n𖡦التكرار .\n𖡦الفيديو .\n𖡦الدخول .\n𖡦الاضافه .\n𖡦الاغاني .\n𖡦الصوت .\n𖡦الملفات .\n𖡦الرسائل .\n𖡦الدردشه .\n𖡦الجهات .\n𖡦السيلفي .\n𖡦التثبيت .\n𖡦الشارحه .\n𖡦الكلايش .\n𖡦البوتات .\n𖡦التوجيه .\n𖡦التعديل .\n𖡦الانلاين .\n𖡦المعرفات .\n𖡦الكيبورد .\n𖡦الفارسيه .\n𖡦الانكليزيه .\n𖡦الاستفتاء .\n𖡦الملصقات .\n𖡦الاشعارات .\n𖡦الماركداون .\n𖡦المتحركات .*","md",true)
elseif text == "م2" or text == "م٢" then    
bot.sendText(msg.chat_id,msg.id,"*𖡦اعدادات المجموعه .\n *ٴ─━─━─━─×─━─━─━─ *\n𖡦( الترحيب ) .\n𖡦( مسح الرتب ) .\n𖡦( الغاء التثبيت ) .\n𖡦( فحص البوت ) .\n𖡦( تعين الرابط ) .\n𖡦( مسح الرابط ) .\n𖡦( تغيير الايدي ) .\n𖡦( تعين الايدي ) .\n𖡦( مسح الايدي ) .\n𖡦( مسح الترحيب ) .\n𖡦( صورتي ) .\n𖡦( تغيير اسم المجموعه ) .\n𖡦( تعين قوانين ) .\n𖡦( تغيير الوصف ) .\n𖡦( مسح القوانين ) .\n𖡦( مسح الرابط ) .\n𖡦( تنظيف التعديل ) .\n𖡦( تنظيف الميديا ) .\n𖡦( مسح الرابط ) .\n𖡦( رفع الادمنيه ) .\n𖡦( تعين ترحيب ) .\n𖡦( الترحيب ) .\n𖡦( الالعاب الاحترافيه ) .\n𖡦( المجموعه ) .*","md",true)
elseif text == "م3" or text == "م٣" then    
bot.sendText(msg.chat_id,msg.id,"*𖡦اوامر التفعيل والتعطيل .\n𖡦تفعيل/تعطيل الامر اسفل . .\n *ٴ─━─━─━─×─━─━─━─ *\n𖡦( اوامر التسليه ) .\n𖡦( الالعاب الاحترافيه ) .\n𖡦( الطرد ) .\n𖡦( الحظر ) .\n𖡦( الرفع ) .\n𖡦( المميزات ) .\n𖡦( المسح التلقائي ) .\n𖡦( ٴall ) .\n𖡦( منو ضافني ) .\n𖡦( تفعيل الردود ) .\n𖡦( الايدي بالصوره ) .\n𖡦( الايدي ) .\n𖡦( التنظيف ) .\n𖡦( الترحيب ) .\n𖡦( الرابط ) .\n𖡦( البايو ) .\n𖡦( صورتي ) .\n𖡦( الالعاب ) .*","md",true)
elseif text == "م4" or text == "م٤" then    
bot.sendText(msg.chat_id,msg.id,"*𖡦اوامر اخرى .\n *ٴ─━─━─━─×─━─━─━─ *\n⌔( الالعاب الاحترافيه ).\n⌔( المجموعه ).\n⌔( الرابط ).\n⌔( اسمي ).\n⌔( ايديي ).\n⌔( مسح نقاطي ).\n⌔( نقاطي ).\n⌔( مسح رسائلي ).\n⌔( رسائلي ).\n⌔( مسح جهاتي ).\n⌔( مسح بالرد  ).\n⌔( تفاعلي ).\n⌔( جهاتي ).\n⌔( مسح سحكاتي ).\n⌔( سحكاتي ).\n⌔( رتبتي ).\n⌔( معلوماتي ).\n⌔( المنشئ ).\n⌔( رفع المنشئ ).\n⌔( البايو/نبذتي ).\n⌔( التاريخ/الساعه ).\n⌔( رابط الحذف ).\n⌔( الالعاب ).\n⌔( منع بالرد ).\n⌔( منع ).\n⌔( تنظيف + عدد ).\n⌔( قائمه المنع ).\n⌔( مسح قائمه المنع ).\n⌔( مسح الاوامر المضافه ).\n⌔( الاوامر المضافه ).\n⌔( ترتيب الاوامر ).\n⌔( اضف امر ).\n⌔( حذف امر ).\n⌔( اضف رد ).\n⌔( حذف رد ).\n⌔( ردود المدير ).\n⌔( مسح الردود المتعدده ).\n⌔( الردود المتعدده ).\n⌔( وضع عدد المسح +رقم ).\n⌔( ٴall ).\n⌔( غنيلي، فلم، متحركه، فيديو، رمزيه ).\n⌔( مسح ردود المدير ).\n⌔( تغير رد {العضو.المميز.الادمن.المدير.المنشئ.المنشئ الاساسي.المالك.المطور } ) .\n⌔( حذف رد {العضو.المميز.الادمن.المدير.المنشئ.المنشئ الاساسي.المالك.المطور} ) .*","md",true)
elseif text == "قفل الكل" then 
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞تم "..text.."*").by,"md",true)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞تم قفل "..text.."*").by,"md",true)
redis:hset(bot_id.."Spam:Group:User"..msg.chat_id ,"Spam:User","del")  
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞تم فتح "..text.."*").by,"md",true)
redis:hdel(bot_id.."Spam:Group:User"..msg.chat_id ,"Spam:User")  
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞تم "..text.." سابقا*").yu,"md",true)  
else
redis:set(bot_id..":"..msg.chat_id..":settings:"..srt,setTyp)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞تم "..text.." بنجاح*").by,"md",true)  
end
end
end
...
local Text = '\n  *ٴ─━─━─━─×─━─━─━─ *\n'
if #list == 0 then 
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞لا يوجد لاعبين*","md",true)
return false
end  
for k, v in pairs(list) do 
Text = Text..k.."-  [" ..v.."] .\n"  
...
local list = redis:smembers(bot_id..':List_Rolet:'..msg.chat_id) 
if #list == 1 then 
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞لم يكتمل العدد الكلي للاعبين*","md",true)  
elseif #list == 0 then 
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞عذرا لم تقوم باضافه اي لاعب*","md",true)  
return false
end 
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞الف مبروك يا* ["..UserName.."] *لقد فزت\n𖡼⁞تم اضافه 3 نقاط لك\n𖡼⁞للعب مره اخره ارسل ~ (* روليت )","md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞المعرف* ["..text.." ] *موجود سابقا ارسل معرف لم يشارك*","md",true)  
return false
end 
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم حفظ المعرف (*["..text.."]*)\n𖡼⁞تم اكمال العدد الكلي\n𖡼⁞ارسل (نعم) للبدء*","md",true)  
return false
end  
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم حفظ المعرف* (["..text.."])\n*𖡼⁞تبقى "..CountUser.." لاعبين ليكتمل العدد\n𖡼⁞ارسل المعرف التالي*","md",true)  
return false
end 
if text and text:match("^(%d+)$") and redis:get(bot_id..":Start_Rolet:"..msg.chat_id..msg.sender.user_id) then
if text == "1" then
bot.sendText(msg.chat_id,msg.id," *𖡼⁞لا استطيع بدء اللعبه بلاعب واحد فقط*","md",true)
elseif text ~= "1" then
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞قم  بأرسال معرفات اللاعبين الان*","md",true)
return false
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞لقد فزت في اللعبه\n𖡼⁞اللعب مره اخره وارسل︙حزوره*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Riddles")
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞لقد فزت في اللعبه\n𖡼⁞اللعب مره اخره وارسل︙معاني*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Meaningof")
end
end
...
return bot.sendText(msg.chat_id,msg.id,"\n*𖡼⁞لقد فزت في اللعبه\n𖡼⁞اللعب مره اخره وارسل︙العكس*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Reflection")
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞لقد فزت في اللعبه\n𖡼⁞اللعب مره اخره وارسل︙سمايل او سمايلات*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Smile")
end
end 
...
redis:incrby(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game", 1)  
return bot.sendText(msg.chat_id,msg.id,"(𖡼⁞لقد فزت في اللعبه\n𖡼⁞اللعب مره اخره وارسل︙امثله*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Example")
end
end
...
redis:incrby(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game", 1)  
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞لقد فزت في اللعبه\n𖡼⁞اللعب مره اخره وارسل︙الاسرع او ترتيب*","md",true)  
end
end
...
redis:incrby(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game", 1)  
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞لقد فزت في اللعبه\n𖡼⁞اللعب مره اخره وارسل︙المختلف*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Difference")
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞يجب ان لا يكون الرقم المخمن اكبر من ( 20 )\n𖡼⁞ خمن رقم بين ال ( 1 و 20 )*","md",true)  
end 
...
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞خمنت الرقم صح\n𖡼⁞تم اضافة ( 5 ) نقاط لك*","md",true)
...
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game:SADD")
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game:Estimate")
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞خسرت في اللعبه\n𖡼⁞حاول في وقت اخر\n𖡼⁞كان الرقم الذي تم تخمينه ( "..GETNUM.." )*","md",true)  
else
return bot.sendText(msg.chat_id,msg.id,"* 𖡼⁞تخمينك من باب الشرجي 😂💓\n ارسل رقم من جديد *","md",true)  
end
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞ارسل عدد اللاعبين للروليت*","md",true)  
end
if text == "خمن" or text == "تخمين" then   
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game:Estimate")
Num = math.random(1,20)
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game:Estimate",Num)  
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞اهلا بك عزيزي في لعبة التخمين \n𖡼⁞ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n𖡼⁞سيتم تخمين عدد ما بين ال (1 و 20 ) اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟*","md",true)  
end
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"📅","📆📆📆????📆📅📆📆")
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞اسرع واحد يدز الاختلاف ~* ( ["..name.."] )","md",true)  
end
if text == "امثله" then
redis:del(bot_id..":"..msg.chat_id..":game:Example")
...
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞اسرع واحد يكمل المثل~* ( ["..name.."] )","md",true)  
end
...
return bot.sendText(msg.chat_id,msg.id,"𖡼⁞اسرع واحد يدز هاذا السمايل ?~ ( "..SM.."}","md",true)  
end
...
return bot.sendText(msg.chat_id,msg.id,"𖡼⁞اسرع واحد يرتبها~ ( ["..name.."] )","md",true)  
end
if text == "حزوره" then
redis:del(bot_id..":"..msg.chat_id..":game:Riddles")
...
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞اسرع واحد يحل الحزوره*\n ( "..name.." )","md",true)  
end
if text == "معاني" then
redis:del(bot_id..":"..msg.chat_id..":game:Meaningof")
...
return bot.sendText(msg.chat_id,msg.id,"𖡼⁞اسرع واحد يدز معنى السمايل~ ( ["..name.."] )","md",true)  
end
if text == "العكس" then
redis:del(bot_id..":"..msg.chat_id..":game:Reflection")
...
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞اسرع واحد يدز العكس ~* ( ["..name.."])","md",true) 
end
end -- end tf
...
t = "*𖡼⁞لم يتم وضع القوانين في المجموعه *"
end
bot.sendText(msg.chat_id,msg.id,t,"md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞اطلق دخول عمري💘 : *"..Usertag..".","md")  
end
end
end
if text == 'رابط الحذف' or text == 'رابط حذف' or text == 'بوت الحذف' or text == 'حذف حساب' then 
local Text = "*𖡼⁞روابط حذف جميع برامج التواصل*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𖡦Telegram ',url="https://my.telegram.org/auth?to=delete"},{text = '𖡦instagram ',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"}},
{{text = '𖡦Facebook ',url="https://www.facebook.com/help/deleteaccount"},{text = '𖡦Snspchat ',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},
{{text = '𖡦⥁𝐓𝐄𝐀𝐌 𝐑𝐎𝐁𝐋𝐗 ',url="t.me/EUUUJ"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/EUUUJ&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعه" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞الساعه الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
...
nameBot = {"ها حبي","نعم تفضل ؟","محتاج شي","عندي اسم وعيونك","تفضل خبصتني","هاشككو","وقزلقرطططط شرايد","عندي اسم وعيونك","بوت اللفك نشالله شتري","كول حياتي","الحجايه هاي لاتجيبها على لسانك بعد","باوع لك خليني احبك وصيحلي باسمي","هاااا فضني"}
bot.sendText(msg.chat_id,msg.id,"*"..nameBot[math.random(#nameBot)].."*","md",true)  
end
if text == "التاريخ" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞التاريخ الان : ( "..os.date("%Y/%m/%d").." )*","md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞البوت لا يمتلك صلاحيه*","md",true)  
return false
end
...
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم "..text.." بنجاح*","md",true)  
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞"..text.." حساب محذوف*","md",true)  
return false
end
if UserInfo.username and UserInfo.username ~= "" then
...
local TestText = "  *𖡼⁞Name : *( "..(t).." *)*\n*𖡼⁞User : *( "..(u).." *)*\n*𖡼⁞Bio :* ["..GetBio(UserInfo.id).."]\n"
keyboardd = {}
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞الاسم : *( "..(t).." *)*\n*𖡼⁞المعرف : *( "..(u).." *)*\n["..GetBio(UserInfo.id).."]","md",true)  
end
end
end
end
...
local UserId_Info = bot.searchPublicChat("PPFFP")
if UserId_Info.id then
...
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞ليس لدي صلاحيه تثبيت رسائل*',"md",true)  
return false
end
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم تثبيت الرساله*","md",true)
...
PermissionsUser = '*\n𖡼⁞صلاحياتك هي :\n *ٴ─━─━─━─×─━─━─━─ *'..'\n𖡼⁞تغيير المعلومات : '..change_info..'\n𖡼⁞تثبيت الرسائل : '..pin_messages..'\n𖡼⁞اضافه مستخدمين : '..invite_users..'\n𖡼⁞مسح الرسائل : '..delete_messages..'\n𖡼⁞حظر المستخدمين : '..restrict_members..'\n𖡼⁞اضافه المشرفين : '..promote..'\n\n*'
end
end
...
bot.sendText(msg.chat_id,msg.id,'\n*𖡼⁞ايديك : '..UserId..'\n𖡼⁞معرفك : '..UserInfousername..'\n𖡼⁞‍رتبتك : '..Get_Rank..'\n𖡼⁞موقعك : '..StatusmC..'\n𖡼⁞رسائلك : '..messageC..'\n𖡼⁞تعديلاتك : '..EditmessageC..'\n𖡼⁞تفاعلك : '..Total_ms..'*'..(PermissionsUser or '') ,"md",true) 
end
...
theId = Description.."\n*𖡼⁞الايدي : (* "..msg.sender.user_id.."* )\n𖡼⁞المعرف :* ( "..UserInfousername.." )\n*𖡼⁞الرتبه : (  "..Get_Rank.." )\n𖡼⁞تفاعلك : (  "..Total_ms.." )\n𖡼⁞عدد الرسائل : ( "..messageC.." )\n𖡼⁞عدد السحكات : ( "..EditmessageC.." )\n𖡼⁞عدد صورك : ( "..TotalPhoto.."* )"
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞اليوزر ليس لحساب شخصي تأكد منه*","md",true)  
return false
end
if UserId_Info.type.is_channel == true then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞اليوزر لقناه او مجموعه تأكد منه*","md",true)  
return false
end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞عذرا يجب ان تستخدم معرف لحساب شخصي فقط*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞الايدي : *( "..(UserId_Info.id).." *)*\n*𖡼⁞المعرف : *( [@"..(UserName).."] *)*\n*𖡼⁞الرتبه : *( "..(Get_Rank(UserId_Info.id,msg.chat_id)).." *)*\n*𖡼⁞الموقع : *( "..(gstatus).." *)*\n*𖡼⁞عدد الرسائل : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..UserId_Info.id..":message") or 1).." *)*" ,"md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞الايدي : *( "..(Remsg.sender.user_id).." *)*\n*𖡼⁞المعرف : *( ["..(uame).."] *)*\n*𖡼⁞الرتبه : *( "..(Get_Rank(Remsg.sender.user_id,msg.chat_id)).." *)*\n*𖡼⁞الموقع : *( "..(gstatus).." *)*\n*𖡼⁞عدد الرسائل : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..Remsg.sender.user_id..":message") or 1).." *)*" ,"md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞الايدي : *( "..(UserName).." *)*\n*𖡼⁞المعرف : *( ["..(uame).."] *)*\n*𖡼⁞الرتبه : *( "..(Get_Rank(UserName,msg.chat_id)).." *)*\n*𖡼⁞الموقع : *( "..(gstatus).." *)*\n*𖡼⁞عدد الرسائل : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..UserName..":message") or 1).." *)*" ,"md",true)  
end
if text == 'رتبتي' then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞رتبتك : *( "..(Get_Rank(msg.sender.user_id,msg.chat_id)).." *)*","md",true)  
return false
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞عدد سحكاتك : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Editmessage") or 0).." *)*","md",true)  
return false
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞تم مسح جميع سحكاتك*',"md",true)   
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Editmessage")
return false
end
if text == 'جهاتي' or text == 'اضافاتي' then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞عدد جهاتك : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Addedmem") or 0).." *)*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞ليس لدي صلاحيه حذف رسائل*',"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞تم مسح جميع جهاتك*',"md",true)   
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞انت منشئ المجموعه*","md",true) 
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم اضافتك بواسطه  : ( *"..(Name).." *)*","md",true)  
else
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞قد قمت بالانضمام عبر الرابط*","md",true) 
return false
end
end
redis:incr(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":message") 
if text == 'رسائلي' then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞عدد رسائلك : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":message") or 1).." *)*","md",true)  
return false
end
if text == 'مسح رسائلي' then
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞تم مسح جميع رسائلك*',"md",true)   
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":message")
return false
end
if text == 'نقاطي' or text == 'مجوهراتي' then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞عدد نقاطك : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game") or 0).." *)*","md",true)  
return false
end
if text and text:match("^بيع نقاطي (%d+)$") then  
local end_n = text:match("^بيع نقاطي (%d+)$")
if tonumber(end_n) == tonumber(0) then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞لا استطيع البيع اقل من 1*","md",true)  
return false 
end
if tonumber(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game")) == tonumber(0) then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞ليس لديك جواهر من الالعاب \n𖡼⁞اذا كنت تريد ربح الجواهر \n𖡼⁞ارسل الالعاب وابدأ اللعب !*","md",true)  
else
local nb = redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game")
if tonumber(end_n) > tonumber(nb) then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞ليس لديك جواهر بهاذا العدد \n𖡼⁞لزيادة مجوهراتك في اللعبه \n𖡼⁞ارسل الالعاب وابدأ اللعب !*","md",true)  
return false
end
local end_d = string.match((end_n * 50), "(%d+)") 
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم خصم* *~ { "..end_n.." }* *من مجوهراتك* \n*𖡼⁞وتم اضافة* *~ { "..end_d.." }* *الى رسائلك*","md",true)  
...
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞تم مسح جميع نقاطك*',"md",true)   
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game")
return false
end
if text == 'ايديي' then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞ايديك : *( "..msg.sender.user_id.." *)*","md",true)  
return false
end
if text == 'اسمي' then
bot.sendText(msg.chat_id,msg.id," *𖡼⁞اسمك : *( "..bot.getUser(msg.sender.user_id).first_name.." *)*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"𖡼⁞_رابط المجموعه : _*"..Get_Chat.title.."*\n  ٴ─━─━─━─×─━─━─━─ \n"..link,"md",true, false, false, false, reply_markup)
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,'\n*𖡼⁞معلومات المجموعه :\n𖡼⁞الايدي : ( '..msg.chat_id..' )\n𖡼⁞عدد الاعضاء : '..Info_Chats.member_count..'\n𖡼⁞عدد الادمنيه : '..Info_Chats.administrator_count..'\n𖡼⁞عدد المطرودين : '..Info_Chats.banned_count..'\n𖡼⁞عدد المقيدين : '..Info_Chats.restricted_count..'\n𖡼⁞الرابط\n : '..Info_Chats.invite_link.invite_link..'*',"md",true, false, false, false, reply_markup)
return false
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞قائمه الالعاب الاحترافيه اضغط للعب*',"md", true, false, false, false, reply_markup)
end
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞لا توجد صوره في حسابك*',"md",true) 
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم حفظ الرابط الجديد بنجاح*","md", true)
else
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞عذرا الرابط خطأ*","md", true)
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم حفظ الايدي الجديد بنجاح*","md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم حفظ الترحيب الجديد بنجاح*","md", true)
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞ليس لدي صلاحيات تغيير المعلومات*',"md",true)  
return false
end
bot.setChatTitle(msg.chat_id,text)
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم تغيير الاسم بنجاح*","md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم تغيير الوصف بنجاح*","md", true)
end
if BasicConstructor(msg) then
if text == 'تغيير اسم المجموعه' then
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":nameGr:add",true)
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞قم بارسال الاسم الجديد الان*","md", true)
end
if text == 'تغيير الوصف' then
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":decGr:add",true)
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞قم بارسال الوصف الجديد الان*","md", true)
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞قم بأرسال قائمه القوانين الان*","md", true)
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then
redis:del(bot_id..":"..msg.chat_id..":Law")
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم "..text.." الجديد بنجاح *","md", true)
end
if text == "تنظيف التعديل" or text == "مسح التعديل" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞يتم البحث عن الرسائل المعدله*","md",true)
...
if y == 0 then 
t = "*𖡼⁞لم يتم العثور على رسائل معدله ضمن 250 رساله السابقه*"
else
t = "*𖡼⁞تم حذف ( "..y.." ) من الرسائل المعدله *"
end
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,t).yu,"md",true)  
end
if text == "تنظيف الميديا" or text == "مسح الميديا" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞يتم البحث عن الميديا*","md",true)
msgid = (msg.id - (1048576*250))
y = 0
r = 1048576
for i=1,250 do
...
if y == 0 then 
t = "*𖡼⁞لم يتم العثور على ميديا ضمن 250 رساله السابقه*"
else
t = "*𖡼⁞تم حذف ( "..y.." ) من الميديا *"
end
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,t).yu,"md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞تم رفع  ('..y..') ادمن بالمجموعه*',"md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞ارسل الان الترحيب الجديد\n𖡼⁞يمكنك اضافه :*\n𖡼⁞`user` > *يوزر المستخدم*\n𖡼⁞`name` > *اسم المستخدم*","md", true)
end
if text == 'الترحيب' then
if redis:get(bot_id..":"..msg.chat_id..":Welcome") then
t = redis:get(bot_id..":"..msg.chat_id..":Welcome")
else 
t = "*𖡼⁞لم يتم وضع ترحيب*"
end
bot.sendText(msg.chat_id,msg.id,t,"md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞ارسل الان النص\n𖡼⁞يمكنك اضافه :*\n𖡼⁞`#username` > *اسم المستخدم*\n𖡼⁞`#msgs` > *عدد رسائل المستخدم*\n𖡼⁞`#photos` > *عدد صور المستخدم*\n𖡼⁞`#id` > *ايدي المستخدم*\n𖡼⁞`#auto` > *تفاعل المستخدم*\n𖡼⁞`#stast` > *موقع المستخدم* \n𖡼⁞`#edit` > *عدد السحكات*\n𖡼⁞`#AddMem` > *عدد الجهات*\n𖡼⁞`#Description` > *تعليق الصوره*","md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم تغير كليشة الايدي*","md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞قم بارسال الرابط الجديد الان*","md", true)
end
if text == 'فحص البوت' then 
local StatusMember = bot.getChatMember(msg.chat_id,bot_id).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞البوت عضو في المجموعه*',"md",true) 
return false
end
local GetMemberStatus = bot.getChatMember(msg.chat_id,bot_id).status
if GetMemberStatus.can_change_info then
...
if msg.can_be_deleted_for_all_users == false then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞البوت ليس ادمن في المجموعه*","md",true)  
return false
end
if GetInfoBot(msg).Delmsg == false then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞البوت لا يمتلك صلاحيه حذف الرسائل*","md",true)  
return false
end
...
bot.sendText(msg.chat_id, msg.id,"*𖡼⁞تم تنظيف ( "..NumMessage.." ) رساله *", 'md')
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم "..text.." بنجاح*","md", true)
end
if text and text:match("^تغير رد المطور (.*)$") then
local Teext = text:match("^تغير رد المطور (.*)$") 
redis:set(bot_id.."Reply:developer"..msg.chat_id,Teext)
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم تغيير الرد بنجاح الى : *"..Teext.. "", 'md')
...
redis:del(bot_id..":Reply:developer"..msg.chat_id)
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم "..text.." بنجاح*", 'md')
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم الغاء تثبيت جميع الرسائل المثبته*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"* 𖡼⁞تحوي قائمه المنع على\n𖡼⁞الصور ( "..Photo.." )\n𖡼⁞الكلمات ( "..Text.." )\n𖡼⁞الملصقات ( "..Sticker.." )\n𖡼⁞المتحركات ( "..Animation.." ) .\n𖡼⁞اضغط على القائمه المراد حذفها*","md",true, false, false, false, reply_markup)
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞قم الان بارسال ( نص او الميديا ) لمنعه من المجموعه*","md",true)  
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم الغاء منع "..ty.." بنجاح*","md",true)  
end
----------------------------------------------------------------------------------------------------
end
----------------------------------------------------------------------------------------------------
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞الايدي : *( `"..(usetid).."` *)*\n*𖡼⁞الرتبه : *( `"..(Get_Rank(usetid,msg.chat_id)).."` *)*\n*𖡼⁞الموقع : *( `"..(gstatus).."` *)*\n*𖡼⁞عدد الرسائل : *( `"..(redis:get(bot_id..":"..msg.chat_id..":"..usetid..":message") or 1).."` *)*" ,"md",true)  
end
end
if Administrator(msg)  then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞الطرد معطل بواسطه المنشئين الاساسيين*").yu,"md",true)
return false
end
end
if GetInfoBot(msg).BanUser == false then
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞البوت لا يمتلك صلاحيه طرد الاعضاء* ',"md",true)  
return false
end
if not Norank(usetid,msg.chat_id) then
t = "*𖡼⁞لا يمكنك طرد "..Get_Rank(usetid,msg.chat_id).."*"
else
t = "*𖡼⁞تم طرده بنجاح*"
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*𖡼⁞لا يمتلك رتبه بالفعل*").yu,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*𖡼⁞تم تنزيله بنجاح*").i,"md",true)  
return false
end
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞الرفع معطل بواسطه المنشئين الاساسيين*").yu,"md",true)  
return false
end
end
if redis:sismember(bot_id..srt1.."Status:"..srt,usetid) then
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*𖡼⁞تم رفعه سابقا*").i,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*𖡼⁞تم رفعه بنجاح*").i,"md",true)  
return false
end
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*𖡼⁞"..tt.."*").yu,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞الكتم معطل بواسطه المنشئين الاساسيين*").yu,"md",true)  
return false
end
end
if not Norank(usetid,msg.chat_id) then
t = "*𖡼⁞لا يمكنك كتم "..Get_Rank(usetid,msg.chat_id).."*"
else
t = "*𖡼⁞تم كتمه بنجاح*"
...
bot.sendText(msg.chat_id,msg.id,"\n*𖡼⁞عذرآ لا تستطيع استخدام الامر على البوت*","md",true)  
return false
end
t = "*𖡼⁞تم الغاء حظره بنجاح*"
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞الحظر معطل بواسطه المنشئين الاساسيين*").yu,"md",true)  
return false
end
end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
...
if not Norank(usetid,msg.chat_id) then
t = "*𖡼⁞لا يمكنك حظر "..Get_Rank(usetid,msg.chat_id).."*"
else
t = "*𖡼⁞تم حظره بنجاح*"
bot.setChatMemberStatus(msg.chat_id,usetid,'banned',0)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*𖡼⁞تم رفع القيود عنه*").i,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*𖡼⁞تم رفع القيود عنه*").i,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*𖡼⁞تم رفع القيود عنه*").i,"md",true)  
return false
end
...
Banal = "𖡼⁞الحظر العام : محظور بالفعل"
else
Banal = "𖡼⁞الحظر العام : غير محظور"
end
if redis:sismember(bot_id..":bot:silent", UserId_Info.id) then
silental  = "𖡼⁞كتم العام : مكتوم بالفعل"
else
silental = "𖡼⁞كتم العام : غير مكتوم"
end
if redis:sismember(bot_id..":"..msg.chat_id..":restrict", UserId_Info.id) then
rict = "𖡼⁞التقييد : مقيد بالفعل"
else
rict = "𖡼⁞التقييد : غير مقيد"
end
if redis:sismember(bot_id..":"..msg.chat_id..":silent", UserId_Info.id) then
sent = "\n𖡼⁞الكتم : مكتوم بالفعل"
else
sent = "\n𖡼⁞الكتم : غير مكتوم"
end
if redis:sismember(bot_id..":"..msg.chat_id..":Ban", UserId_Info.id) then
an = "\n𖡼⁞الحظر : محظور بالفعل"
else
an = "\n𖡼⁞الحظر : غير محظور"
end
...
if GetInfoBot(msg).BanUser == false then
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞البوت لا يمتلك صلاحيه تقييد الاعضاء* ',"md",true)  
return false
end
if not Norank(UserName,msg.chat_id) then
t = "*𖡼⁞لا يمكنك تقييد "..Get_Rank(UserName,msg.chat_id).."*"
else
t = "*𖡼⁞تم تقييده بنجاح*"
...
t = "*𖡼⁞لا يمكنك تقييد "..Get_Rank(UserId_Info.id,msg.chat_id).."*"
else
t = "*𖡼⁞تم تقييده بنجاح*"
...
bot.sendText(msg.chat_id,msg.id,"\n*𖡼⁞عذرآ تستطيع فقط استخدام الامر على المستخدمين*","md",true)  
return false
end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
bot.sendText(msg.chat_id,msg.id,"\n*𖡼⁞عذرآ لا تستطيع استخدام الامر على البوت*","md",true)  
...
t = "*𖡼⁞لا يمكنك تقييد "..Get_Rank(Remsg.sender.user_id,msg.chat_id).."*"
else
t = "*𖡼⁞تم تقييده بنجاح*"
...
if not Norank(UserName,msg.chat_id) then
t = "*𖡼⁞لا يمكنك طرد "..Get_Rank(UserName,msg.chat_id).."*"
else
t = "*𖡼⁞تم طرده بنجاح*"
...
if not Norank(UserId_Info.id,msg.chat_id) then
t = "*𖡼⁞لا يمكنك طرد "..Get_Rank(UserId_Info.id,msg.chat_id).."*"
else
t = "*𖡼⁞تم طرده بنجاح*"
...
if not Norank(Remsg.sender.user_id,msg.chat_id) then
t = "*𖡼⁞لا يمكنك طرد "..Get_Rank(Remsg.sender.user_id,msg.chat_id).."*"
else
t = "*𖡼⁞تم طرده بنجاح*"
...
if not Norank(UserName,msg.chat_id) then
t = "*𖡼⁞لا يمكنك حظر "..Get_Rank(UserName,msg.chat_id).."*"
else
t = "*𖡼⁞تم حظره بنجاح*"
bot.setChatMemberStatus(msg.chat_id,UserName,'banned',0)
...
if not Norank(UserId_Info.id,msg.chat_id) then
t = "*𖡼⁞لا يمكنك حظر "..Get_Rank(UserId_Info.id,msg.chat_id).."*"
else
t = "*𖡼⁞تم حظره بنجاح*"
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Norank(Remsg.sender.user_id,msg.chat_id) then
t = "*𖡼⁞لا يمكنك حظر "..Get_Rank(Remsg.sender.user_id,msg.chat_id).."*"
else
t = "*𖡼⁞تم حظره بنجاح*"
bot.setChatMemberStatus(msg.chat_id,Remsg.sender.user_id,'banned',0)
...
if not Norank(UserName,msg.chat_id) then
t = "*𖡼⁞لا يمكنك كتم "..Get_Rank(UserName,msg.chat_id).."*"
else
t = "*𖡼⁞تم كتمه بنجاح*"
...
if not Norank(UserId_Info.id,msg.chat_id) then
t = "*𖡼⁞لا يمكنك كتم "..Get_Rank(UserId_Info.id,msg.chat_id).."*"
else
t = "*𖡼⁞تم كتمه بنجاح*"
...
if not Norank(Remsg.sender.user_id,msg.chat_id) then
t = "*𖡼⁞لا يمكنك كتم "..Get_Rank(Remsg.sender.user_id,msg.chat_id).."*"
else
t = "*𖡼⁞تم كتمه بنجاح*"
...
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞لا يوجد "..text:gsub('ال',"").."*").yu,"md",true)  
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
if UserInfo and UserInfo.username and UserInfo.username ~= "" then
t = t.."*"..k.." 𖡼⁞*[@"..UserInfo.username.."](tg://user?id="..v..")\n"
else
t = t.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n"
end
end
...
local Info_ = redis:smembers(bot_id..":"..msg.chat_id..":Ban") 
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞تم حذف "..text:gsub('مسح',"").." سابقا*").yu,"md",true)  
return false
end  
for k, v in pairs(Info_) do
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞تم "..text.." بنجاح*").yu,"md",true)  
end
...
if GetInfoBot(msg).BanUser == false then
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞البوت لا يمتلك صلاحيه حظر عام الاعضاء* ',"md",true)  
return false
end
if not Isrank(UserName,msg.chat_id) then
t = "*𖡼⁞لا يمكنك حظر عام "..Get_Rank(UserName,msg.chat_id).."*"
else
t = "*𖡼⁞تم حظر العام بنجاح*"
bot.setChatMemberStatus(msg.chat_id,UserName,'banned',0)
...
if not Isrank(UserId_Info.id,msg.chat_id) then
t = "*𖡼⁞لا يمكنك حظر عام "..Get_Rank(UserId_Info.id,msg.chat_id).."*"
else
t = "*𖡼⁞تم حظر العام بنجاح*"
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Isrank(Remsg.sender.user_id,msg.chat_id) then
t = "*𖡼⁞لا يمكنك حظر عام "..Get_Rank(Remsg.sender.user_id,msg.chat_id).."*"
else
t = "*𖡼⁞تم حظر العام بنجاح*"
bot.setChatMemberStatus(msg.chat_id,Remsg.sender.user_id,'banned',0)
...
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم عمل تاك في المجموعه قبل قليل انتظر من فضلك*","md",true) 
end
...
local members = Info.members
if #members <= 9 then
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞لا يوجد عدد كافي من الاعضاء*","md",true) 
end
for k, v in pairs(members) do
local UserInfo = bot.getUser(v.member_id.user_id)
...
local Mesge = v
if Mesge then
t = "*𖡼⁞تم مسح "..k.." من الوسائط تلقائيا\n𖡼⁞يمكنك تعطيل الميزه بستخدام الامر ( تعطيل المسح التلقائي )*"
...
if redis:get(bot_id..":"..msg.chat_id..":settings:mediaAude") then
Text = Reply_Status(msg.sender.user_id,"*𖡼⁞تم "..text.." سابقا*").yu
else
Text = Reply_Status(msg.sender.user_id,"*𖡼⁞تم "..text.." بنجاح*").by
...
t = "*𖡼⁞تم تعيين  ( "..Teext.." ) كعدد للحذف التلقائي*"
redis:set(bot_id..":mediaAude:utdl"..msg.chat_id,Teext)
else
t = "𖡼⁞عذرا يجب كتابه ( وضع عدد المسح + رقم )"
end
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,t).yu,"md",true)
end
if text == ("عدد الميديا") then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞عدد الميديا هو :  "..redis:scard(bot_id..":"..msg.chat_id..":mediaAude:ids").."*").yu,"md",true)
end
--
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*𖡼⁞"..tt.."*").yu,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*𖡼⁞"..tt.."*").yu,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*𖡼⁞"..tt.."*").yu,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*𖡼⁞تم رفعه سابقا*").i,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*𖡼⁞تم رفعه بنجاح*").i,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*𖡼⁞تم رفعه سابقا*").i,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*𖡼⁞تم رفعه بنجاح*").i,"md",true)  
return false
end
end
if text and text:match("^رفع (.*)$") and tonumber(msg.reply_to_message_id) ~= 0 then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*𖡼⁞تم رفعه سابقا*").i,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*𖡼⁞تم رفعه بنجاح*").i,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*𖡼⁞لا يمتلك رتبه بالفعل*").yu,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*𖡼⁞تم تنزيله بنجاح*").i,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*𖡼⁞لا يمتلك رتبه بالفعل*").yu,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*𖡼⁞تم تنزيله بنجاح*").i,"md",true)  
return false
end
end
if text and text:match("^تنزيل (.*)$") and tonumber(msg.reply_to_message_id) ~= 0 then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*𖡼⁞لا يمتلك رتبه بالفعل*").yu,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*𖡼⁞تم تنزيله بنجاح*").i,"md",true)  
return false
end
end
----------------------------------------------------------------------------------------------------
...
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞لا يوجد المالكين*").yu,"md",true)  
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
...
if redis:get(bot_id..":"..msg.chat_id..":Features") then
return bot.sendText(msg.chat_id,msg.id,"*𖡼⁞تم تعطيل المميزات بواسطه المدراء*","md",true)  
end
keyboard = {} 
keyboard.inline_keyboard = {
{
...
return https.request("https://api.telegram.org/bot"..Token.."/sendVoice?chat_id="..msg.chat_id.."&voice=https://t.me/Teamsulta/"..math.random(2,552).."&caption="..URL.escape("𖡦تم اختيار الاغنيه لك").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendVideo?chat_id="..msg.chat_id.."&video=https://t.me/FFF3KK/"..math.random(2,80).."&caption="..URL.escape("𖡦تم ختيار الفيديو لك .").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendAnimation?chat_id="..msg.chat_id.."&animation=https://t.me/FFF4KK/"..math.random(2,300).."&caption="..URL.escape("𖡦تم اختيار المتحركه لك").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendVideo?chat_id="..msg.chat_id.."&video=https://t.me/RRRRRTQ/"..math.random(2,86).."&caption="..URL.escape("𖡦تم اختيار الفلم لك").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendPhoto?chat_id="..msg.chat_id.."&photo=https://t.me/FFF6KK/"..math.random(2,135).."&caption="..URL.escape("𖡦تم اختيار الرمزيه لك").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendPhoto?chat_id="..msg.chat_id.."&photo=https://t.me/AnimeDavid/"..math.random(2,135).."&caption="..URL.escape("𖡦تم اختيار انمي لك").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendVideo?chat_id="..msg.chat_id.."&video=https://t.me/shaarshahum/"..math.random(2,86).."&caption="..URL.escape("𖡦تم اختيار الشعر لك").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if msg.content.text then
...
local msgg = msg.id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token.."/sendVideo?chat_id="..msg.chat_id.."&Video=https://t.me/EKKKK9/"..math.random(2,86).."&caption="..URL.escape("𖡦تم اختيار راب لك").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
----------------------------------------------------------------------------------------------------
end
...
local Text = "*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ Smile\n\n*[𖡦 Smile ᴄʜᴀɴɴᴇʟ](http://t.me/EUUUJ)*\n\n*[𖡦 ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/EUUUJ)*\n\n*[𖡦 Smile ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/PPFFP)*\n\n*[𖡦 ʙᴏᴛ Smile](http://t.me/EinoTwsbot)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⥁𝐓𝐄𝐀𝐌 𝐑𝐎𝐁𝐋𝐗 ',url="t.me/EUUUJ"}
...
if text == 'تيست' then 
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'قناة السورس', url = 't.me/EUUUJ'}, },}}
return bot.sendText(msg.chat_id,msg.id,'*\n￤عذراً ، عليك الأشتراك في قناة البوت أولاً ،*',"md",false, false, false, false, reply_markup)
end
...
if msg.can_be_deleted_for_all_users == false then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞عذراً البوت ليس ادمن في المجموعه*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞عذراً يجب أنْ تكون مشرف او مالك المجموعه*","md",true)  
return false
end
end
if sm.status.luatele == "chatMemberStatusCreator" then
...
if redis:sismember(bot_id..":Groups",msg.chat_id) then
 bot.sendText(msg.chat_id,msg.id,'*𖡼⁞تم تفعيل المجموعه سابقا*',"md",true)  
return false
else
Get_Chat = bot.getChat(msg.chat_id)
Info_Chats = bot.getSupergroupFullInfo(msg.chat_id)
...
bot.sendText(sudoid,0,'*\n𖡼⁞تم تفعيل مجموعه جديده \n𖡼⁞بواسطه : (*['..UserInfo..'](tg://user?id='..msg.sender.user_id..')*)\n𖡼⁞معلومات المجموعه :\n𖡼⁞عدد الاعضاء : '..Info_Chats.member_count..'\n𖡼⁞عدد الادمنيه : '..Info_Chats.administrator_count..'\n𖡼⁞عدد المطرودين : '..Info_Chats.banned_count..'\n𖡼⁞عدد المقيدين : '..Info_Chats.restricted_count..'\n𖡼⁞الرابط\n : '..Info_Chats.invite_link.invite_link..'*',"md", true, false, false, false, reply_markup)
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞تم تفعيل المجموعه بنجاح*',"md", true, false, false, false, reply_markup)
...
if not developer(msg) then
if sm.status.luatele ~= "chatMemberStatusCreator" then
bot.sendText(msg.chat_id,msg.id,"*𖡼⁞عذراً يجب أنْ تكون مالك المجموعه فقط*","md",true)  
return false
end
end
if redis:sismember(bot_id..":Groups",msg.chat_id) then
...
UserInfo = bot.getUser(msg.sender.user_id).first_name
bot.sendText(sudoid,0,'*\n𖡼⁞تم تعطيل المجموعه التاليه : \n𖡼⁞بواسطه : (*['..UserInfo..'](tg://user?id='..msg.sender.user_id..')*)\n𖡼⁞معلومات المجموعه :\n𖡼⁞عدد الاعضاء : '..Info_Chats.member_count..'\n𖡼⁞عدد الادمنيه : '..Info_Chats.administrator_count..'\n𖡼⁞عدد المطرودين : '..Info_Chats.banned_count..'\n𖡼⁞عدد المقيدين : '..Info_Chats.restricted_count..'\n𖡼⁞الرابط\n : '..Info_Chats.invite_link.invite_link..'*',"md", true, false, false, false, reply_markup)
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞تم تعطيل المجموعه بنجاح*',"md",true, false, false, false, reply_markup)
redis:srem(bot_id..":Groups",msg.chat_id)
local keys = redis:keys(bot_id..'*'..'-100'..data.supergroup.id..'*')
redis:del(bot_id..":"..msg.chat_id..":Status:Creator")
redis:del(bot_id..":"..msg.chat_id..":Status:BasicConstructor")
...
bot.sendText(msg.chat_id,msg.id,'*𖡼⁞المجموعه معطله بالفعل*',"md", true)
end
end
----------------------------------------------------------------------------------------------------
end --- end Run
...
return bot.sendText(sudoid,0,'𖡼⁞تم طرد البوت من مجموعه جديده\n𖡼⁞معلومات المجموعه :\n𖡼⁞الايدي : ( -100'..data.supergroup.id..' )\n*𖡼⁞عدد الاعضاء : '..Info_Chats.member_count..'\n𖡼⁞عدد الادمنيه : '..Info_Chats.administrator_count..'\n𖡼⁞عدد المطرودين : '..Info_Chats.banned_count..'\n𖡼⁞عدد المقيدين : '..Info_Chats.restricted_count..'\n𖡼⁞الرابط\n : '..Info_Chats.invite_link.invite_link..'*',"md",true, false, false, false, reply_markup)
end
end
end
...
t = "𖡼⁞تم حذف الامر بنجاح"
else
t = " 𖡼⁞عذراً الامر  ( "..data.message.content.text.text.." ) غير موجود "
end
...
return bot.sendText(data.message.chat_id,data.message.id,Reply_Status(data.message.sender.user_id,"*𖡼⁞عليك الاشتراك في قناة البوت اولاً !*").yu,"md", true, false, false, false, reply_dev)
end
end
end
end
...
if hash then    
bot.deleteMessages(data.message.chat_id,{[1]= data.message.id})
bot.sendText(data.message.chat_id,data.message.id,Reply_Status(data.message.sender.user_id,"*𖡼⁞"..tu.." "..ut.." من المجموعه*").yu,"md",true)  
end
end
...
if photo.total_count > 0 then
bot.sendPhoto(data.message.chat_id, data.message.id, photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id,"*𖡼⁞اهلا بك في بوت الحمايه\n𖡼⁞وضيفتي حمايه المجموعات من السبام والتفليش والخ..\n𖡼⁞لتفعيل البوت ارسل كلمه *تفعيل", 'md', nil, nil, nil, nil, nil, nil, nil, nil, nil, kup)
else
bot.sendText(data.message.chat_id,data.message.id,"*𖡼⁞اهلا بك في بوت الحمايه \n𖡼⁞وضيفتي حمايه المجموعات من السبام والتفليش والخ..\n𖡼⁞لتفعيل البوت ارسل كلمه *تفعيل","md",true, false, false, false, kup)
end
end
end
end
...
if hash then    
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡼⁞"..tu.." "..ut.." من المجموعه*").yu,"md",true)  
end
end
Run(msg,data)
...
if #lsme == 0 then
t = "*𖡼⁞لا يوجد مشرفين في المجموعه*"
end
bot.sendText(msg.chat_id,msg.id,t,"md", true)
end
end
