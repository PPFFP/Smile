...
JoinChannel = true
local url , res = https.request('https://api.telegram.org/bot/getchatmember?chat_id=@SMILEXB&user_id='..msg.sender.user_id)
...
return {
by   = '\n*𖡦︙بواسطه : *'..UserInfousername..'\n'..TextMsg,
i   = '\n*𖡦︙المستخدم : *'..UserInfousername..'\n'..TextMsg,
yu    = '\n*𖡦︙عزيزي : *'..UserInfousername..'\n'..TextMsg
}
end
function getJson(R)  
...
File:close()
bot.sendDocument(R,0,'./'..bot_id..'.json', '𖡦︙تم جلب النسخه الاحتياطيه', 'md')
end
...
bot.editMessageText(chat_id,msg_id,"* 𖡦︙تحوي قائمه المنع على\n𖡦︙الصور ( "..Photo.." )\n𖡦︙الكلمات ( "..Text.." )\n𖡦︙الملصقات ( "..Sticker.." )\n𖡦︙المتحركات ( "..Animation.." )\n𖡦︙اضغط على القائمه المراد حذفها*", 'md', true, false, reply_markup)
...
type = 'inline',
data = {
{{text = '𖡦𝖲𝗈𝗎𝗋𝖼𝖾 Smile',url="t.me/SMILEXB"}},
}
}
if redis:get(bot_id..'Set:array'..user_id..':'..chat_id) == 'true1' then
redis:del(bot_id..'Set:array'..user_id..':'..chat_id)
bot.editMessageText(chat_id,msg_id,"*𖡦︙تم حفظ الردود بنجاح*", 'md', true, false, reply_markup)
else
bot.editMessageText(chat_id,msg_id," *𖡦︙تم تنفيذ الامر سابقا*", 'md', true, false, reply_markup)
end
end
...
bot.editMessageText(chat_id,msg_id,"* 𖡦︙لا يمتلك البوت صلاحيه حظر الاعضاء*", 'md', true, false, reply_markup)
return false
end   
if not Isrank(data.sender_user_id,chat_id) then
t = "*𖡦︙لا يمكن للبوت حظر "..Get_Rank(data.sender_user_id,chat_id).."*"
else
t = "*𖡦︙تم طردك بنجاح*"
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙تم الغاء العمليه الطرد بنجاح*", 'md', true, false, reply_markup)
end
end
...
{{text = "ᴘʀᴏᴛᴇᴄᴛɪᴏɴ¹" ,data="Amr_"..data.sender_user_id.."_1"},{text = "ѕᴇᴛᴛɪɴɢѕ²",data="Amr_"..data.sender_user_id.."_2"}},
{{text = "ᴏᴘᴇɴ /ᴄʟᴏѕᴇ³",data="Amr_"..data.sender_user_id.."_3"},{text ="ᴏᴛʜᴇʀѕ⁴",data="Amr_"..data.sender_user_id.."_4"}},
{{text = '𝖲𝗈𝗎𝗋𝖼𝖾 Smile .',url="t.me/SMILEXB"}},
}
}
t = "*𖡦︙قائمه الاوامر \n *ٴ─━─━─━─×─━─━─━─ *\n𖡦︙م1 ( اوامر الحمايه ) \n𖡦︙م2 ( اوامر إعدادات المجموعه ) \n𖡦︙م3 ( اوامر القفل والفتح ) \n𖡦︙م4 ( اوامر اخرى ) *"
end
bot.editMessageText(chat_id,msg_id,t, 'md', true, false, reply_markup)
end
----------------------------------------------------------------------------------------------------
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙اعدادات المجموعه *", 'md', true, false, reply_markup)
end
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙اهلا بك في قائمه الاوامر : العلامه ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس*", 'md', true, false, reply_dev)
end
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙قم بأعاده ارسال الملف الخاص بالنسخه*", 'md', true, false, reply_markup)
redis:set(bot_id..":set:"..chat_id..":UpfJson",true) 
end
if Text == "GetfJson" then
bot.answerCallbackQuery(data.id, "𖡦︙جار ارسال النسخه", true)
getJson(chat_id)
dofile("start.lua")
end
if Text == "Delch" then
if not redis:get(bot_id..":TheCh") then
bot.answerCallbackQuery(data.id, "𖡦︙لم يتم وضع اشتراك في البوت", true)
return false
end
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙تم حذف البوت بنجاح*", 'md', true, false, reply_markup)
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙قم برفع البوت ادمن في قناتك ثم قم بأرسل توجيه من القناه الى البوت*", 'md', true, false, reply_markup)
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙الاشتراك الاجباري على القناه اسفل :*", 'md', true, false, reply_dev)
end
if Text == "indfo" then
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙اهلا بك في قسم الاحصائيات \n *ٴ─━─━─━─×─━─━─━─ *\n𖡦︙عدد المشتركين ( "..user_id.." ) عضو \n𖡦︙عدد المجموعات ( "..Groups.." ) مجموعه *", 'md', true, false, reply_dev)
end
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙اهلا بك في لوحه اوامر الاشتراك الاجباري*", 'md', true, false, reply_dev)
end
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙قم الان بأرسل ايدي المطور الجديد*", 'md', true, false, reply_markup)
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙قم الان بأرسل كليشه ستارت الجديده*", 'md', true, false, reply_markup)
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙قم الان بأرسل اسم البوت الجديد*", 'md', true, false, reply_markup)
...
return bot.editMessageText(chat_id,msg_id,'*𖡦︙العدد الكلي ( '..#list..' )\n𖡦︙تم العثور على ( '..x..' ) من المشتركين الوهميين*', 'md', true, false, reply_dev)
else
return bot.editMessageText(chat_id,msg_id,'*𖡦︙العدد الكلي ( '..#list.." )\n𖡦︙لم يتم العثور على وهميين*", 'md', true, false, reply_dev)
end
end
if Text == "clenMg" then
...
x = x + 1
bot.sendText(Get_Chat.id,0,'*𖡦︙البوت ليس ادمن في المجموعه*',"md")
...
return bot.editMessageText(chat_id,msg_id,'*𖡦︙العدد الكلي ( '..#list..' )\n𖡦︙تم العثور على ( '..x..' ) من المجموعات الوهميه*', 'md', true, false, reply_dev)
else
return bot.editMessageText(chat_id,msg_id,'*𖡦︙العدد الكلي ( '..#list.." )\n𖡦︙لم يتم العثور على مجموعات وهميه*", 'md', true, false, reply_dev)
end
end
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙اوامر الاذاعه الخاصه بالبوت*", 'md', true, false, reply_dev)
end
...
bot.editMessageText(chat_id,msg_id,"*𖡦︙قم الان بأرسال الرساله *", 'md', true, false, reply_markup)
end
----------------------------------------------------------------------------------------------------
end
end
...
if TrS == "Fall" then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙يتم توجيه الرساله الى ( "..#lis.." عضو ) و ( "..#list.." مجموعه ) *","md",true)      
for k,v in pairs(list) do
...
redis:del(bot_id..":count:true") 
elseif TrS == "Fme" then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙يتم توجيه الرساله الى ( "..#lis.." عضو ) *","md",true)      
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙يتم ارسال الرساله الى ( "..#lis.." عضو ) و ( "..#list.." مجموعه ) *","md",true)      
for k,v in pairs(list) do
...
redis:del(bot_id..":count:true") 
elseif TrS == "Tgr" then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙يتم ارسال الرساله الى ( "..#list.." مجموعه ) *","md",true)      
for k,v in pairs(list) do
local FedMsg = bot.forwardMessages(v, msg.chat_id, msg.id,0,0,true,true,false)
if FedMsg then
redis:incr(bot_id..":count:true") 
...
redis:del(bot_id..":count:true") 
elseif TrS == "Tme" then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙يتم ارسال الرساله الى ( "..#lis.." عضو ) *","md",true)      
for k,v in pairs(lis) do
local FedMsg = bot.forwardMessages(v, msg.chat_id, msg.id,0,0,true,true,false)
if FedMsg then
redis:incr(bot_id..":count:true") 
...
return bot.sendText(msg.chat_id,msg.id,'*𖡦︙عذرا الملف هذا ليس للبوت*')
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم رفع النسخه بنجاح*","md")
end     
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙عذرا يجب عليك ارسل توجيه من قناه فقط*","md")
return false
end     
sm = bot.getChatMember(id_chat,bot_id)
if sm.status.luatele == "chatMemberStatusAdministrator" then
redis:set(bot_id..":TheCh",id_chat) 
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم حفظ القناه بنجاح *","md", true)
else
bot.sendText(msg.chat_id,msg.id,"*𖡦︙البوت ليس مشرف بالقناه*","md", true)
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم تغيير المطور الاساسي بنجاح*","md", true)
dofile("start.lua")
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙اهلا بك في قائمه الاوامر : العلامه ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس*","md", true, false, false, false, reply_dev)
end
end
...
if text == "/start" then 
bot.sendText(msg.chat_id,msg.id,"*𖡦︙اهلا بك في قائمه الاوامر : العلامه ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس*","md", true, false, false, false, bot.replyMarkup{
type = 'inline',data = {
	{{text = '𖡦الاحصائيات',data="indfo"}},
	{{text = '𖡦تغيير المطور الاساسي',data="EditDevbot"}},
{{text = '𖡦تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "اينو"),data="delnamebot"}},
...
bot.sendText(sudoid,0,Reply_Status(msg.sender.user_id,"*𖡦︙قام بدخول الى البوت عدد اعضاء البوت الان ( "..scarduser_id.." ) .*").i,"md",true)
end
end
...
r ="*𖡦︙اهلا بك في بوت الحمايه  \n𖡦︙وضيفتي حمايه المجموعات من السبام والتفليش والخ..\n𖡦︙لتفعيل البوت ارسل كلمه *تفعيل"
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,'*𖡦︙تم ارسال رسالتك الى المطور*').yu,"md",true)
...
bot.sendText(IdSudo,0,Reply_Status(msg.sender.user_id,'*𖡦︙قام بارسال الملصق*').i,"md",true)  
return false
end
else
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,'*𖡦︙انت محظور من البوت*').yu,"md",true)  
end
end
end
end
...
if text == 'حظر' then
bot.sendText(msg.chat_id,0,Reply_Status(id_user,'*𖡦︙تم حظره بنجاح*').i,"md",true)
redis:sadd(bot_id.."banTo",id_user)  
return false  
end 
if text =='الغاء الحظر' then
bot.sendText(msg.chat_id,0,Reply_Status(id_user,'*𖡦︙تم الغاء حظره بنجاح*').i,"md",true)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(id_user,'*𖡦︙تم ارسال رسالتك اليه*').i,"md",true)  
end
end
end
----------------------------------------------------------------------------------------------------
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙تم قفل التوجيه في المجموعه*").yu,"md",true)  
end
end
...
bot.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙قام بالتكرار في المجموعه وتم حظره*").yu,"md",true)
...
bot.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙قام بالتكرار في المجموعه وتم تقييده*").yu,"md",true)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙قام بالتكرار في المجموعه وتم كتمه*").yu,"md",true)  
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙التثبيت معطل من قبل المدراء*","md",true)
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم منع الكلمه سابقا*","md",true)
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم منع الملصق سابقا*","md",true)
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم منع المتحركه سابقا*","md",true)
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم منع الصوره سابقا*","md",true)
return false
end
redis:sadd(bot_id.."mn:content:Photo"..msg.chat_id,msg.content.photo.sizes[1].photo.remote.unique_id)  
ty = "الصوره"
end
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم منع "..ty.." بنجاح*","md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم حفظ الرد بنجاح*","md",true)  
return false
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم المغادره من المجموعه*","md",true)
...
if programmer(msg) then  
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم تحديث السورس الى الاصدار الجديد*","md",true)
os.execute('rm -rf start.lua')
...
if text == "تحديث" then
if programmer(msg) then  
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم تحديث ملفات البوت*","md",true)
dofile("start.lua")
end 
end
if Constructor(msg) then
if text == ("مسح ردود المدير") then
ext = "*𖡦︙تم مسح قائمه ردود المدير*"
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم حفظ الامر بنجاح*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙قم الان بأرسال الامر الجديد*","md",true)  
return false
end
end
if text == "حذف امر" then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙قم بأرسال الامر الجديد الان*","md",true)
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Command:del",true)
end
if text == "اضف امر" then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙قم الان بأرسال الامر القديم*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙قم بارسال الرد الذي تريد اضافته*","md",true)  
return false
end
if text == "اضف رد" then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙ارسل الان الكلمه لاضافتها في الردود*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم حذف الرد بنجاح*","md",true)  
end
end
if text == "حذف رد" then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙ارسل الان الكلمه لحذفها من الردود*","md",true)
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Rp:del",true)
end
if text == ("ردود المدير") then
local list = redis:smembers(bot_id.."List:Rp:content"..msg.chat_id)
ext = "𖡦︙قائمه ردود المدير\n  ٴ─━─━─━─×─━─━─━─ \n"
for k,v in pairs(list) do
...
if #list == 0 then
ext = "𖡦︙عذرا لا يوجد ردود للمدير في المجموعه"
end
bot.sendText(msg.chat_id,msg.id,"["..ext.."]","md",true)  
end
----------------------------------------------------------------------------------------------------
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم مسح الاوامر بنجاح*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙ارسل الكلمه الرد الذي تريد اضافتها*","md",true)  
return false
end
end
...
return bot.sendText(msg.chat_id,msg.id,' *𖡦︙تم حفظ الرد يمكنك ارسال اخر او اكمال العمليه من خلال الزر اسفل ✅*',"md",true, false, false, false, reply_ad)
end
if text and text:match("^(.*)$") then
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙لا يوجد رد متعدد* ","md",true)  
return false
end
redis:srem(bot_id.."Add:Rd:array:Text"..gery..msg.chat_id,text)
bot.sendText(msg.chat_id,msg.id,' *𖡦︙تم حذفه بنجاح* ',"md",true)  
end
end
if text and text:match("^(.*)$") then
...
bot.sendText(msg.chat_id,msg.id,' *𖡦︙قم بارسال الرد الذي تريد حذفه منه* ',"md",true)  
return false
end
end
if text == "حذف رد من متعدد" and Owner(msg) then
redis:set(bot_id.."Set:array:Ssd"..msg.sender.user_id..":"..msg.chat_id,"delrd")
bot.sendText(msg.chat_id,msg.id,"*𖡦︙ارسل الكلمه الرد الاصليه*","md",true)  
return false
end
if text and text:match("^(.*)$") then
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم حذف الرد المتعدد بنجاح*","md",true)  
return false
end
end
...
t = Reply_Status(msg.sender.user_id,"\n *ٴ─━─━─━─×─━─━─━─ *\n*𖡦︙قائمه الردود المتعدده*\n  *ٴ─━─━─━─×─━─━─━─ *\n").yu
for k,v in pairs(list) do
t = t..""..k..">> ("..v..") » {رساله}\n"
end
if #list == 0 then
t = "*𖡦︙لا يوجد ردود متعدده*"
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم مسح الردود المتعدده*","md",true)  
end
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '⌁︙ 𝖲𝗈𝗎𝗋𝖼𝖾 Smile', url = 't.me/SMILEXB'}, },}}
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم ترتيب الاوامر بالشكل التالي \n𖡦︙رفع\n𖡦︙حاته-حات- صاك-صاكه-ملك-ملكه-مبرمج-مطي-طلي-خروف-جلب-جلبه-حصان-قرد-مرتي-زوجي *","md",true)  
end
end
if text == "اوامر التسليه" or text == "اوامر التسلية" then    
bot.sendText(msg.chat_id,msg.id,"*𖡦︙ترتيب اوامر التسليه\n𖡦︙بوسه\n𖡦︙بوسها\n𖡦︙مصه\n𖡦︙مصها\n𖡦︙كت\n𖡦︙رزله\n𖡦︙هينه\n𖡦︙رزلها\n𖡦︙هينها\n𖡦︙لك رزله\n𖡦︙لك هينه\n𖡦︙تفله\n𖡦︙لك تفله\n𖡦︙شنو رئيك بهذا\n𖡦︙شنو رئيك بهاي*","md",true)
end
if Administrator(msg) then
if text == 'مسح البوتات' or text == 'حذف البوتات' or text == 'طرد البوتات' then            
if GetInfoBot(msg).BanUser == false then
bot.sendText(msg.chat_id,msg.id,'*𖡦︙البوت لا يمتلك صلاحيه حظر الاعضاء* ',"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم حظر ( "..i.." ) من البوتات في المجموعه*","md",true)  
end
if text == 'البوتات' then  
local Info = bot.searchChatMembers(msg.chat_id, "*", 200)
local members = Info.members
ls = "*𖡦︙قائمه البوتات في المجموعه\n  *ٴ─━─━─━─×─━─━─━─ *\n𖡦︙العلامه 《 *★ * 》 تدل على ان البوت مشرف*\n *ٴ─━─━─━─×─━─━─━─ *\n"
i = 0
for k, v in pairs(members) do
UserInfo = bot.getUser(v.member_id.user_id) 
if UserInfo.type.luatele == "userTypeBot" then 
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙قائمه الاوامر\n *ٴ─━─━─━─×─━─━─━─ *\n𖡦︙م1 ( اوامر الحمايه \n𖡦︙م2 ( اوامر إعدادات المجموعه )\n𖡦︙م3 ( اوامر القفل والفتح )\n𖡦︙م4 ( اوامر اخرى )*","md", true, false, false, false, reply_markup)
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙تم "..text.."*").by,"md",true)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙تم قفل "..text.."*").by,"md",true)
redis:hset(bot_id.."Spam:Group:User"..msg.chat_id ,"Spam:User","del")  
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙تم فتح "..text.."*").by,"md",true)
redis:hdel(bot_id.."Spam:Group:User"..msg.chat_id ,"Spam:User")  
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙تم "..text.." سابقا*").yu,"md",true)  
else
redis:set(bot_id..":"..msg.chat_id..":settings:"..srt,setTyp)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙تم "..text.." بنجاح*").by,"md",true)  
end
end
end
...
local Text = '\n  *ٴ─━─━─━─×─━─━─━─ *\n'
if #list == 0 then 
bot.sendText(msg.chat_id,msg.id,"*𖡦︙لا يوجد لاعبين*","md",true)
return false
end  
for k, v in pairs(list) do 
Text = Text..k.."-  [" ..v.."] .\n"  
...
local list = redis:smembers(bot_id..':List_Rolet:'..msg.chat_id) 
if #list == 1 then 
bot.sendText(msg.chat_id,msg.id,"*𖡦︙لم يكتمل العدد الكلي للاعبين*","md",true)  
elseif #list == 0 then 
bot.sendText(msg.chat_id,msg.id,"*𖡦︙عذرا لم تقوم باضافه اي لاعب*","md",true)  
return false
end 
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙الف مبروك يا* ["..UserName.."] *لقد فزت\n𖡦︙تم اضافه 3 نقاط لك\n𖡦︙للعب مره اخره ارسل ~ (* روليت )","md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙المعرف* ["..text.." ] *موجود سابقا ارسل معرف لم يشارك*","md",true)  
return false
end 
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم حفظ المعرف (*["..text.."]*)\n𖡦︙تم اكمال العدد الكلي\n𖡦︙ارسل (نعم) للبدء*","md",true)  
return false
end  
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم حفظ المعرف* (["..text.."])\n*𖡦︙تبقى "..CountUser.." لاعبين ليكتمل العدد\n𖡦︙ارسل المعرف التالي*","md",true)  
return false
end 
if text and text:match("^(%d+)$") and redis:get(bot_id..":Start_Rolet:"..msg.chat_id..msg.sender.user_id) then
if text == "1" then
bot.sendText(msg.chat_id,msg.id," *𖡦︙لا استطيع بدء اللعبه بلاعب واحد فقط*","md",true)
elseif text ~= "1" then
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙قم  بأرسال معرفات اللاعبين الان*","md",true)
return false
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙لقد فزت في اللعبه\n𖡦︙اللعب مره اخره وارسل︙حزوره*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Riddles")
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙لقد فزت في اللعبه\n𖡦︙اللعب مره اخره وارسل︙معاني*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Meaningof")
end
end
...
return bot.sendText(msg.chat_id,msg.id,"\n*𖡦︙لقد فزت في اللعبه\n𖡦︙اللعب مره اخره وارسل︙العكس*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Reflection")
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙لقد فزت في اللعبه\n𖡦︙اللعب مره اخره وارسل︙سمايل او سمايلات*","md",true)  
---else
---redis:del(bot_id..":"..msg.chat_id..":game:Smile")
end
end 
...
redis:incrby(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game", 1)  
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙لقد فزت في اللعبه\n𖡦︙اللعب مره اخره وارسل︙الاسرع او ترتيب*","md",true)  
end
end
...
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙يجب ان لا يكون الرقم المخمن اكبر من ( 20 )\n𖡦︙ خمن رقم بين ال ( 1 و 20 )*","md",true)  
end 
...
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙خمنت الرقم صح\n𖡦︙تم اضافة ( 5 ) نقاط لك*","md",true)
...
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game:SADD")
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game:Estimate")
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙خسرت في اللعبه\n𖡦︙حاول في وقت اخر\n𖡦︙كان الرقم الذي تم تخمينه ( "..GETNUM.." )*","md",true)  
else
return bot.sendText(msg.chat_id,msg.id,"* 𖡦︙تخمينك من باب الشرجي 😂💓\n ارسل رقم من جديد *","md",true)  
end
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙ارسل عدد اللاعبين للروليت*","md",true)  
end
if text == "خمن" or text == "تخمين" then   
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game:Estimate")
Num = math.random(1,20)
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game:Estimate",Num)  
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙اهلا بك عزيزي في لعبة التخمين \n𖡦︙ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n𖡦︙سيتم تخمين عدد ما بين ال (1 و 20 ) اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟*","md",true)  
end
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"📅","📆📆📆????📆📅📆📆")
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙اسرع واحد يدز الاختلاف ~* ( ["..name.."] )","md",true)  
end
if text == "امثله" then
redis:del(bot_id..":"..msg.chat_id..":game:Example")
...
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙اسرع واحد يكمل المثل~* ( ["..name.."] )","md",true)  
end
...
return bot.sendText(msg.chat_id,msg.id,"𖡦︙اسرع واحد يدز هاذا السمايل ?~ ( "..SM.."}","md",true)  
end
...
return bot.sendText(msg.chat_id,msg.id,"𖡦︙اسرع واحد يرتبها~ ( ["..name.."] )","md",true)  
end
if text == "حزوره" then
redis:del(bot_id..":"..msg.chat_id..":game:Riddles")
...
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙اسرع واحد يحل الحزوره*\n ( "..name.." )","md",true)  
end
if text == "معاني" then
redis:del(bot_id..":"..msg.chat_id..":game:Meaningof")
...
return bot.sendText(msg.chat_id,msg.id,"𖡦︙اسرع واحد يدز معنى السمايل~ ( ["..name.."] )","md",true)  
end
if text == "العكس" then
redis:del(bot_id..":"..msg.chat_id..":game:Reflection")
...
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙اسرع واحد يدز العكس ~* ( ["..name.."])","md",true) 
end
end -- end tf
...
t = "*𖡦︙لم يتم وضع القوانين في المجموعه *"
end
bot.sendText(msg.chat_id,msg.id,t,"md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙اطلق دخول عمري💘 : *"..Usertag..".","md")  
end
end
end
if text == 'رابط الحذف' or text == 'رابط حذف' or text == 'بوت الحذف' or text == 'حذف حساب' then 
local Text = "*𖡦︙روابط حذف جميع برامج التواصل*\n"
keyboard = {} 
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/SMILEXB&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعه" then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙الساعه الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙التاريخ الان : ( "..os.date("%Y/%m/%d").." )*","md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙البوت لا يمتلك صلاحيه*","md",true)  
return false
end
...
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم "..text.." بنجاح*","md",true)  
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙"..text.." حساب محذوف*","md",true)  
return false
end
if UserInfo.username and UserInfo.username ~= "" then
...
local TestText = "  *𖡦︙Name : *( "..(t).." *)*\n*𖡦︙User : *( "..(u).." *)*\n*𖡦︙Bio :* ["..GetBio(UserInfo.id).."]\n"
keyboardd = {}
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙الاسم : *( "..(t).." *)*\n*𖡦︙المعرف : *( "..(u).." *)*\n["..GetBio(UserInfo.id).."]","md",true)  
end
end
end
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡦︙ليس لدي صلاحيه تثبيت رسائل*',"md",true)  
return false
end
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم تثبيت الرساله*","md",true)
...
bot.sendText(msg.chat_id,msg.id,'\n*𖡦︙ايديك : '..UserId..'\n𖡦︙معرفك : '..UserInfousername..'\n𖡦︙‍رتبتك : '..Get_Rank..'\n𖡦︙موقعك : '..StatusmC..'\n𖡦︙رسائلك : '..messageC..'\n𖡦︙تعديلاتك : '..EditmessageC..'\n𖡦︙تفاعلك : '..Total_ms..'*'..(PermissionsUser or '') ,"md",true) 
end
...
theId = Description.."\n*𖡦︙الايدي : (* "..msg.sender.user_id.."* )\n𖡦︙المعرف :* ( "..UserInfousername.." )\n*𖡦︙الرتبه : (  "..Get_Rank.." )\n𖡦︙تفاعلك : (  "..Total_ms.." )\n𖡦︙عدد الرسائل : ( "..messageC.." )\n𖡦︙عدد السحكات : ( "..EditmessageC.." )\n𖡦︙عدد صورك : ( "..TotalPhoto.."* )"
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙اليوزر ليس لحساب شخصي تأكد منه*","md",true)  
return false
end
if UserId_Info.type.is_channel == true then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙اليوزر لقناه او مجموعه تأكد منه*","md",true)  
return false
end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙عذرا يجب ان تستخدم معرف لحساب شخصي فقط*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙الايدي : *( "..(UserId_Info.id).." *)*\n*𖡦︙المعرف : *( [@"..(UserName).."] *)*\n*𖡦︙الرتبه : *( "..(Get_Rank(UserId_Info.id,msg.chat_id)).." *)*\n*𖡦︙الموقع : *( "..(gstatus).." *)*\n*𖡦︙عدد الرسائل : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..UserId_Info.id..":message") or 1).." *)*" ,"md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙الايدي : *( "..(Remsg.sender.user_id).." *)*\n*𖡦︙المعرف : *( ["..(uame).."] *)*\n*𖡦︙الرتبه : *( "..(Get_Rank(Remsg.sender.user_id,msg.chat_id)).." *)*\n*𖡦︙الموقع : *( "..(gstatus).." *)*\n*𖡦︙عدد الرسائل : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..Remsg.sender.user_id..":message") or 1).." *)*" ,"md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙الايدي : *( "..(UserName).." *)*\n*𖡦︙المعرف : *( ["..(uame).."] *)*\n*𖡦︙الرتبه : *( "..(Get_Rank(UserName,msg.chat_id)).." *)*\n*𖡦︙الموقع : *( "..(gstatus).." *)*\n*𖡦︙عدد الرسائل : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..UserName..":message") or 1).." *)*" ,"md",true)  
end
if text == 'رتبتي' then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙رتبتك : *( "..(Get_Rank(msg.sender.user_id,msg.chat_id)).." *)*","md",true)  
return false
end
if text == 'سحكاتي' or text == 'تعديلاتي' then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙عدد سحكاتك : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Editmessage") or 0).." *)*","md",true)  
return false
end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
bot.sendText(msg.chat_id,msg.id,'*𖡦︙تم مسح جميع سحكاتك*',"md",true)   
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Editmessage")
return false
end
if text == 'جهاتي' or text == 'اضافاتي' then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙عدد جهاتك : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":Addedmem") or 0).." *)*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡦︙ليس لدي صلاحيه حذف رسائل*',"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡦︙تم مسح جميع جهاتك*',"md",true)   
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙انت منشئ المجموعه*","md",true) 
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم اضافتك بواسطه  : ( *"..(Name).." *)*","md",true)  
else
bot.sendText(msg.chat_id,msg.id,"*𖡦︙قد قمت بالانضمام عبر الرابط*","md",true) 
return false
end
end
redis:incr(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":message") 
if text == 'رسائلي' then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙عدد رسائلك : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":message") or 1).." *)*","md",true)  
return false
end
if text == 'مسح رسائلي' then
bot.sendText(msg.chat_id,msg.id,'*𖡦︙تم مسح جميع رسائلك*',"md",true)   
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":message")
return false
end
if text == 'نقاطي' or text == 'مجوهراتي' then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙عدد نقاطك : *( "..(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game") or 0).." *)*","md",true)  
return false
end
if text and text:match("^بيع نقاطي (%d+)$") then  
local end_n = text:match("^بيع نقاطي (%d+)$")
if tonumber(end_n) == tonumber(0) then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙لا استطيع البيع اقل من 1*","md",true)  
return false 
end
if tonumber(redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game")) == tonumber(0) then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙ليس لديك جواهر من الالعاب \n𖡦︙اذا كنت تريد ربح الجواهر \n𖡦︙ارسل الالعاب وابدأ اللعب !*","md",true)  
else
local nb = redis:get(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game")
if tonumber(end_n) > tonumber(nb) then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙ليس لديك جواهر بهاذا العدد \n𖡦︙لزيادة مجوهراتك في اللعبه \n𖡦︙ارسل الالعاب وابدأ اللعب !*","md",true)  
return false
end
local end_d = string.match((end_n * 50), "(%d+)") 
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم خصم* *~ { "..end_n.." }* *من مجوهراتك* \n*𖡦︙وتم اضافة* *~ { "..end_d.." }* *الى رسائلك*","md",true)  
...
bot.sendText(msg.chat_id,msg.id,'*𖡦︙تم مسح جميع نقاطك*',"md",true)   
redis:del(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":game")
return false
end
if text == 'ايديي' then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙ايديك : *( "..msg.sender.user_id.." *)*","md",true)  
return false
end
if text == 'اسمي' then
bot.sendText(msg.chat_id,msg.id," *𖡦︙اسمك : *( "..bot.getUser(msg.sender.user_id).first_name.." *)*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"𖡦︙_رابط المجموعه : _*"..Get_Chat.title.."*\n  ٴ─━─━─━─×─━─━─━─ \n"..link,"md",true, false, false, false, reply_markup)
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡦︙قائمه الالعاب الاحترافيه اضغط للعب*',"md", true, false, false, false, reply_markup)
end
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡦︙لا توجد صوره في حسابك*',"md",true) 
end
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم حفظ الرابط الجديد بنجاح*","md", true)
else
bot.sendText(msg.chat_id,msg.id,"*𖡦︙عذرا الرابط خطأ*","md", true)
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم حفظ الايدي الجديد بنجاح*","md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم حفظ الترحيب الجديد بنجاح*","md", true)
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡦︙ليس لدي صلاحيات تغيير المعلومات*',"md",true)  
return false
end
bot.setChatTitle(msg.chat_id,text)
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم تغيير الاسم بنجاح*","md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم تغيير الوصف بنجاح*","md", true)
end
if BasicConstructor(msg) then
if text == 'تغيير اسم المجموعه' then
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":nameGr:add",true)
bot.sendText(msg.chat_id,msg.id,"*𖡦︙قم بارسال الاسم الجديد الان*","md", true)
end
if text == 'تغيير الوصف' then
redis:set(bot_id..":"..msg.chat_id..":"..msg.sender.user_id..":decGr:add",true)
bot.sendText(msg.chat_id,msg.id,"*𖡦︙قم بارسال الوصف الجديد الان*","md", true)
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙قم بأرسال قائمه القوانين الان*","md", true)
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then
redis:del(bot_id..":"..msg.chat_id..":Law")
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم "..text.." الجديد بنجاح *","md", true)
end
if text == "تنظيف التعديل" or text == "مسح التعديل" then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙يتم البحث عن الرسائل المعدله*","md",true)
...
if y == 0 then 
t = "*𖡦︙لم يتم العثور على رسائل معدله ضمن 250 رساله السابقه*"
else
t = "*𖡦︙تم حذف ( "..y.." ) من الرسائل المعدله *"
end
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,t).yu,"md",true)  
end
if text == "تنظيف الميديا" or text == "مسح الميديا" then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙يتم البحث عن الميديا*","md",true)
msgid = (msg.id - (1048576*250))
y = 0
r = 1048576
for i=1,250 do
...
if y == 0 then 
t = "*𖡦︙لم يتم العثور على ميديا ضمن 250 رساله السابقه*"
else
t = "*𖡦︙تم حذف ( "..y.." ) من الميديا *"
end
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,t).yu,"md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,'*𖡦︙تم رفع  ('..y..') ادمن بالمجموعه*',"md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙ارسل الان الترحيب الجديد\n𖡦︙يمكنك اضافه :*\n𖡦︙`user` > *يوزر المستخدم*\n𖡦︙`name` > *اسم المستخدم*","md", true)
end
if text == 'الترحيب' then
if redis:get(bot_id..":"..msg.chat_id..":Welcome") then
t = redis:get(bot_id..":"..msg.chat_id..":Welcome")
else 
t = "*𖡦︙لم يتم وضع ترحيب*"
end
bot.sendText(msg.chat_id,msg.id,t,"md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙ارسل الان النص\n𖡦︙يمكنك اضافه :*\n𖡦︙`#username` > *اسم المستخدم*\n𖡦︙`#msgs` > *عدد رسائل المستخدم*\n𖡦︙`#photos` > *عدد صور المستخدم*\n𖡦︙`#id` > *ايدي المستخدم*\n𖡦︙`#auto` > *تفاعل المستخدم*\n𖡦︙`#stast` > *موقع المستخدم* \n𖡦︙`#edit` > *عدد السحكات*\n𖡦︙`#AddMem` > *عدد الجهات*\n𖡦︙`#Description` > *تعليق الصوره*","md", true)
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم تغير كليشة الايدي*","md",true)  
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙قم بارسال الرابط الجديد الان*","md", true)
end
if text == 'فحص البوت' then 
local StatusMember = bot.getChatMember(msg.chat_id,bot_id).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
bot.sendText(msg.chat_id,msg.id,'*𖡦︙البوت عضو في المجموعه*',"md",true) 
return false
end
local GetMemberStatus = bot.getChatMember(msg.chat_id,bot_id).status
if GetMemberStatus.can_change_info then
...
if msg.can_be_deleted_for_all_users == false then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙البوت ليس ادمن في المجموعه*","md",true)  
return false
end
if GetInfoBot(msg).Delmsg == false then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙البوت لا يمتلك صلاحيه حذف الرسائل*","md",true)  
return false
end
...
bot.sendText(msg.chat_id, msg.id,"*𖡦︙تم تنظيف ( "..NumMessage.." ) رساله *", 'md')
end
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم "..text.." بنجاح*","md", true)
end
if text and text:match("^تغير رد المطور (.*)$") then
local Teext = text:match("^تغير رد المطور (.*)$") 
redis:set(bot_id.."Reply:developer"..msg.chat_id,Teext)
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم تغيير الرد بنجاح الى : *"..Teext.. "", 'md')
...
redis:del(bot_id..":Reply:developer"..msg.chat_id)
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم "..text.." بنجاح*", 'md')
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم الغاء تثبيت جميع الرسائل المثبته*","md",true)
...
bot.sendText(msg.chat_id,msg.id,"* 𖡦︙تحوي قائمه المنع على\n𖡦︙الصور ( "..Photo.." )\n𖡦︙الكلمات ( "..Text.." )\n𖡦︙الملصقات ( "..Sticker.." )\n𖡦︙المتحركات ( "..Animation.." ) .\n𖡦︙اضغط على القائمه المراد حذفها*","md",true, false, false, false, reply_markup)
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙قم الان بارسال ( نص او الميديا ) لمنعه من المجموعه*","md",true)  
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم الغاء منع "..ty.." بنجاح*","md",true)  
end
----------------------------------------------------------------------------------------------------
end
----------------------------------------------------------------------------------------------------
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙الايدي : *( `"..(usetid).."` *)*\n*𖡦︙الرتبه : *( `"..(Get_Rank(usetid,msg.chat_id)).."` *)*\n*𖡦︙الموقع : *( `"..(gstatus).."` *)*\n*𖡦︙عدد الرسائل : *( `"..(redis:get(bot_id..":"..msg.chat_id..":"..usetid..":message") or 1).."` *)*" ,"md",true)  
end
end
if Administrator(msg)  then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙الطرد معطل بواسطه المنشئين الاساسيين*").yu,"md",true)
return false
end
end
if GetInfoBot(msg).BanUser == false then
bot.sendText(msg.chat_id,msg.id,'*𖡦︙البوت لا يمتلك صلاحيه طرد الاعضاء* ',"md",true)  
return false
end
if not Norank(usetid,msg.chat_id) then
t = "*𖡦︙لا يمكنك طرد "..Get_Rank(usetid,msg.chat_id).."*"
else
t = "*𖡦︙تم طرده بنجاح*"
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*𖡦︙لا يمتلك رتبه بالفعل*").yu,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*𖡦︙تم تنزيله بنجاح*").i,"md",true)  
return false
end
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙الرفع معطل بواسطه المنشئين الاساسيين*").yu,"md",true)  
return false
end
end
if redis:sismember(bot_id..srt1.."Status:"..srt,usetid) then
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*𖡦︙تم رفعه سابقا*").i,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*𖡦︙تم رفعه بنجاح*").i,"md",true)  
return false
end
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(usetid,"*𖡦︙"..tt.."*").yu,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙الكتم معطل بواسطه المنشئين الاساسيين*").yu,"md",true)  
return false
end
end
if not Norank(usetid,msg.chat_id) then
t = "*𖡦︙لا يمكنك كتم "..Get_Rank(usetid,msg.chat_id).."*"
else
t = "*𖡦︙تم كتمه بنجاح*"
...
bot.sendText(msg.chat_id,msg.id,"\n*𖡦︙عذرآ لا تستطيع استخدام الامر على البوت*","md",true)  
return false
end
t = "*𖡦︙تم الغاء حظره بنجاح*"
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙الحظر معطل بواسطه المنشئين الاساسيين*").yu,"md",true)  
return false
end
end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
...
if not Norank(usetid,msg.chat_id) then
t = "*𖡦︙لا يمكنك حظر "..Get_Rank(usetid,msg.chat_id).."*"
else
t = "*𖡦︙تم حظره بنجاح*"
bot.setChatMemberStatus(msg.chat_id,usetid,'banned',0)
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*𖡦︙تم رفع القيود عنه*").i,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*𖡦︙تم رفع القيود عنه*").i,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*𖡦︙تم رفع القيود عنه*").i,"md",true)  
return false
end
...
Banal = "𖡦︙الحظر العام : محظور بالفعل"
else
Banal = "𖡦︙الحظر العام : غير محظور"
end
if redis:sismember(bot_id..":bot:silent", UserId_Info.id) then
silental  = "𖡦︙كتم العام : مكتوم بالفعل"
else
silental = "𖡦︙كتم العام : غير مكتوم"
end
if redis:sismember(bot_id..":"..msg.chat_id..":restrict", UserId_Info.id) then
rict = "𖡦︙التقييد : مقيد بالفعل"
else
rict = "𖡦︙التقييد : غير مقيد"
end
if redis:sismember(bot_id..":"..msg.chat_id..":silent", UserId_Info.id) then
sent = "\n𖡦︙الكتم : مكتوم بالفعل"
else
sent = "\n𖡦︙الكتم : غير مكتوم"
end
if redis:sismember(bot_id..":"..msg.chat_id..":Ban", UserId_Info.id) then
an = "\n𖡦︙الحظر : محظور بالفعل"
else
an = "\n𖡦︙الحظر : غير محظور"
end
...
if GetInfoBot(msg).BanUser == false then
bot.sendText(msg.chat_id,msg.id,'*𖡦︙البوت لا يمتلك صلاحيه تقييد الاعضاء* ',"md",true)  
return false
end
if not Norank(UserName,msg.chat_id) then
t = "*𖡦︙لا يمكنك تقييد "..Get_Rank(UserName,msg.chat_id).."*"
else
t = "*𖡦︙تم تقييده بنجاح*"
...
t = "*𖡦︙لا يمكنك تقييد "..Get_Rank(UserId_Info.id,msg.chat_id).."*"
else
t = "*𖡦︙تم تقييده بنجاح*"
...
bot.sendText(msg.chat_id,msg.id,"\n*𖡦︙عذرآ تستطيع فقط استخدام الامر على المستخدمين*","md",true)  
return false
end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
bot.sendText(msg.chat_id,msg.id,"\n*𖡦︙عذرآ لا تستطيع استخدام الامر على البوت*","md",true)  
...
t = "*𖡦︙لا يمكنك تقييد "..Get_Rank(Remsg.sender.user_id,msg.chat_id).."*"
else
t = "*𖡦︙تم تقييده بنجاح*"
...
if not Norank(UserName,msg.chat_id) then
t = "*𖡦︙لا يمكنك طرد "..Get_Rank(UserName,msg.chat_id).."*"
else
t = "*𖡦︙تم طرده بنجاح*"
...
if not Norank(UserId_Info.id,msg.chat_id) then
t = "*𖡦︙لا يمكنك طرد "..Get_Rank(UserId_Info.id,msg.chat_id).."*"
else
t = "*𖡦︙تم طرده بنجاح*"
...
if not Norank(Remsg.sender.user_id,msg.chat_id) then
t = "*𖡦︙لا يمكنك طرد "..Get_Rank(Remsg.sender.user_id,msg.chat_id).."*"
else
t = "*𖡦︙تم طرده بنجاح*"
...
if not Norank(UserName,msg.chat_id) then
t = "*𖡦︙لا يمكنك حظر "..Get_Rank(UserName,msg.chat_id).."*"
else
t = "*𖡦︙تم حظره بنجاح*"
bot.setChatMemberStatus(msg.chat_id,UserName,'banned',0)
...
if not Norank(UserId_Info.id,msg.chat_id) then
t = "*𖡦︙لا يمكنك حظر "..Get_Rank(UserId_Info.id,msg.chat_id).."*"
else
t = "*𖡦︙تم حظره بنجاح*"
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Norank(Remsg.sender.user_id,msg.chat_id) then
t = "*𖡦︙لا يمكنك حظر "..Get_Rank(Remsg.sender.user_id,msg.chat_id).."*"
else
t = "*𖡦︙تم حظره بنجاح*"
bot.setChatMemberStatus(msg.chat_id,Remsg.sender.user_id,'banned',0)
...
if not Norank(UserName,msg.chat_id) then
t = "*𖡦︙لا يمكنك كتم "..Get_Rank(UserName,msg.chat_id).."*"
else
t = "*𖡦︙تم كتمه بنجاح*"
...
if not Norank(UserId_Info.id,msg.chat_id) then
t = "*𖡦︙لا يمكنك كتم "..Get_Rank(UserId_Info.id,msg.chat_id).."*"
else
t = "*𖡦︙تم كتمه بنجاح*"
...
if not Norank(Remsg.sender.user_id,msg.chat_id) then
t = "*𖡦︙لا يمكنك كتم "..Get_Rank(Remsg.sender.user_id,msg.chat_id).."*"
else
t = "*𖡦︙تم كتمه بنجاح*"
...
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙لا يوجد "..text:gsub('ال',"").."*").yu,"md",true)  
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
if UserInfo and UserInfo.username and UserInfo.username ~= "" then
t = t.."*"..k.." 𖡦︙*[@"..UserInfo.username.."](tg://user?id="..v..")\n"
else
t = t.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n"
end
end
...
local Info_ = redis:smembers(bot_id..":"..msg.chat_id..":Ban") 
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙تم حذف "..text:gsub('مسح',"").." سابقا*").yu,"md",true)  
return false
end  
for k, v in pairs(Info_) do
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙تم "..text.." بنجاح*").yu,"md",true)  
end
...
if GetInfoBot(msg).BanUser == false then
bot.sendText(msg.chat_id,msg.id,'*𖡦︙البوت لا يمتلك صلاحيه حظر عام الاعضاء* ',"md",true)  
return false
end
if not Isrank(UserName,msg.chat_id) then
t = "*𖡦︙لا يمكنك حظر عام "..Get_Rank(UserName,msg.chat_id).."*"
else
t = "*𖡦︙تم حظر العام بنجاح*"
bot.setChatMemberStatus(msg.chat_id,UserName,'banned',0)
...
if not Isrank(UserId_Info.id,msg.chat_id) then
t = "*𖡦︙لا يمكنك حظر عام "..Get_Rank(UserId_Info.id,msg.chat_id).."*"
else
t = "*𖡦︙تم حظر العام بنجاح*"
bot.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Isrank(Remsg.sender.user_id,msg.chat_id) then
t = "*𖡦︙لا يمكنك حظر عام "..Get_Rank(Remsg.sender.user_id,msg.chat_id).."*"
else
t = "*𖡦︙تم حظر العام بنجاح*"
bot.setChatMemberStatus(msg.chat_id,Remsg.sender.user_id,'banned',0)
...
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم عمل تاك في المجموعه قبل قليل انتظر من فضلك*","md",true) 
end
...
local members = Info.members
if #members <= 9 then
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙لا يوجد عدد كافي من الاعضاء*","md",true) 
end
for k, v in pairs(members) do
local UserInfo = bot.getUser(v.member_id.user_id)
...
local Mesge = v
if Mesge then
t = "*𖡦︙تم مسح "..k.." من الوسائط تلقائيا\n𖡦︙يمكنك تعطيل الميزه بستخدام الامر ( تعطيل المسح التلقائي )*"
...
if redis:get(bot_id..":"..msg.chat_id..":settings:mediaAude") then
Text = Reply_Status(msg.sender.user_id,"*𖡦︙تم "..text.." سابقا*").yu
else
Text = Reply_Status(msg.sender.user_id,"*𖡦︙تم "..text.." بنجاح*").by
...
t = "*𖡦︙تم تعيين  ( "..Teext.." ) كعدد للحذف التلقائي*"
redis:set(bot_id..":mediaAude:utdl"..msg.chat_id,Teext)
else
t = "𖡦︙عذرا يجب كتابه ( وضع عدد المسح + رقم )"
end
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,t).yu,"md",true)
end
if text == ("عدد الميديا") then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙عدد الميديا هو :  "..redis:scard(bot_id..":"..msg.chat_id..":mediaAude:ids").."*").yu,"md",true)
end
--
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*𖡦︙"..tt.."*").yu,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*𖡦︙"..tt.."*").yu,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*𖡦︙"..tt.."*").yu,"md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*𖡦︙تم رفعه سابقا*").i,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*𖡦︙تم رفعه بنجاح*").i,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*𖡦︙تم رفعه سابقا*").i,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*𖡦︙تم رفعه بنجاح*").i,"md",true)  
return false
end
end
if text and text:match("^رفع (.*)$") and tonumber(msg.reply_to_message_id) ~= 0 then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*𖡦︙تم رفعه سابقا*").i,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*𖡦︙تم رفعه بنجاح*").i,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*𖡦︙لا يمتلك رتبه بالفعل*").yu,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserName,"*𖡦︙تم تنزيله بنجاح*").i,"md",true)  
return false
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*𖡦︙لا يمتلك رتبه بالفعل*").yu,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*𖡦︙تم تنزيله بنجاح*").i,"md",true)  
return false
end
end
if text and text:match("^تنزيل (.*)$") and tonumber(msg.reply_to_message_id) ~= 0 then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*𖡦︙لا يمتلك رتبه بالفعل*").yu,"md",true)  
return false
end
if devB(msg.sender.user_id) then
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender.user_id,"*𖡦︙تم تنزيله بنجاح*").i,"md",true)  
return false
end
end
----------------------------------------------------------------------------------------------------
...
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙لا يوجد المالكين*").yu,"md",true)  
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
...
if redis:get(bot_id..":"..msg.chat_id..":Features") then
return bot.sendText(msg.chat_id,msg.id,"*𖡦︙تم تعطيل المميزات بواسطه المدراء*","md",true)  
end
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == 'تيست' then 
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'قناة السورس', url = 't.me/SMILEXB'}, },}}
return bot.sendText(msg.chat_id,msg.id,'*\n￤عذراً ، عليك الأشتراك في قناة البوت أولاً ،*',"md",false, false, false, false, reply_markup)
end
...
if msg.can_be_deleted_for_all_users == false then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙عذراً البوت ليس ادمن في المجموعه*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*𖡦︙عذراً يجب أنْ تكون مشرف او مالك المجموعه*","md",true)  
return false
end
end
if sm.status.luatele == "chatMemberStatusCreator" then
...
if redis:sismember(bot_id..":Groups",msg.chat_id) then
 bot.sendText(msg.chat_id,msg.id,'*𖡦︙تم تفعيل المجموعه سابقا*',"md",true)  
return false
else
Get_Chat = bot.getChat(msg.chat_id)
Info_Chats = bot.getSupergroupFullInfo(msg.chat_id)
...
bot.sendText(sudoid,0,'*\n𖡦︙تم تفعيل مجموعه جديده \n𖡦︙بواسطه : (*['..UserInfo..'](tg://user?id='..msg.sender.user_id..')*)\n𖡦︙معلومات المجموعه :\n𖡦︙عدد الاعضاء : '..Info_Chats.member_count..'\n𖡦︙عدد الادمنيه : '..Info_Chats.administrator_count..'\n𖡦︙عدد المطرودين : '..Info_Chats.banned_count..'\n𖡦︙عدد المقيدين : '..Info_Chats.restricted_count..'\n𖡦︙الرابط\n : '..Info_Chats.invite_link.invite_link..'*',"md", true, false, false, false, reply_markup)
bot.sendText(msg.chat_id,msg.id,'*𖡦︙تم تفعيل المجموعه بنجاح*',"md", true, false, false, false, reply_markup)
...
if not developer(msg) then
if sm.status.luatele ~= "chatMemberStatusCreator" then
bot.sendText(msg.chat_id,msg.id,"*𖡦︙عذراً يجب أنْ تكون مالك المجموعه فقط*","md",true)  
return false
end
end
if redis:sismember(bot_id..":Groups",msg.chat_id) then
...
UserInfo = bot.getUser(msg.sender.user_id).first_name
bot.sendText(sudoid,0,'*\n𖡦︙تم تعطيل المجموعه التاليه : \n𖡦︙بواسطه : (*['..UserInfo..'](tg://user?id='..msg.sender.user_id..')*)\n𖡦︙معلومات المجموعه :\n𖡦︙عدد الاعضاء : '..Info_Chats.member_count..'\n𖡦︙عدد الادمنيه : '..Info_Chats.administrator_count..'\n𖡦︙عدد المطرودين : '..Info_Chats.banned_count..'\n𖡦︙عدد المقيدين : '..Info_Chats.restricted_count..'\n𖡦︙الرابط\n : '..Info_Chats.invite_link.invite_link..'*',"md", true, false, false, false, reply_markup)
bot.sendText(msg.chat_id,msg.id,'*𖡦︙تم تعطيل المجموعه بنجاح*',"md",true, false, false, false, reply_markup)
redis:srem(bot_id..":Groups",msg.chat_id)
local keys = redis:keys(bot_id..'*'..'-100'..data.supergroup.id..'*')
redis:del(bot_id..":"..msg.chat_id..":Status:Creator")
redis:del(bot_id..":"..msg.chat_id..":Status:BasicConstructor")
...
bot.sendText(msg.chat_id,msg.id,'*𖡦︙المجموعه معطله بالفعل*',"md", true)
end
end
----------------------------------------------------------------------------------------------------
end --- end Run
...
return bot.sendText(sudoid,0,'𖡦︙تم طرد البوت من مجموعه جديده\n𖡦︙معلومات المجموعه :\n𖡦︙الايدي : ( -100'..data.supergroup.id..' )\n*𖡦︙عدد الاعضاء : '..Info_Chats.member_count..'\n𖡦︙عدد الادمنيه : '..Info_Chats.administrator_count..'\n𖡦︙عدد المطرودين : '..Info_Chats.banned_count..'\n𖡦︙عدد المقيدين : '..Info_Chats.restricted_count..'\n𖡦︙الرابط\n : '..Info_Chats.invite_link.invite_link..'*',"md",true, false, false, false, reply_markup)
end
end
end
...
t = "𖡦︙تم حذف الامر بنجاح"
else
t = " 𖡦︙عذراً الامر  ( "..data.message.content.text.text.." ) غير موجود "
end
...
return bot.sendText(data.message.chat_id,data.message.id,Reply_Status(data.message.sender.user_id,"*𖡦︙عليك الاشتراك في قناة البوت اولاً !*").yu,"md", true, false, false, false, reply_dev)
end
end
end
end
...
if hash then    
bot.deleteMessages(data.message.chat_id,{[1]= data.message.id})
bot.sendText(data.message.chat_id,data.message.id,Reply_Status(data.message.sender.user_id,"*𖡦︙"..tu.." "..ut.." من المجموعه*").yu,"md",true)  
end
end
...
if photo.total_count > 0 then
bot.sendPhoto(data.message.chat_id, data.message.id, photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id,"*𖡦︙اهلا بك في بوت الحمايه\n𖡦︙وضيفتي حمايه المجموعات من السبام والتفليش والخ..\n𖡦︙لتفعيل البوت ارسل كلمه *تفعيل", 'md', nil, nil, nil, nil, nil, nil, nil, nil, nil, kup)
else
bot.sendText(data.message.chat_id,data.message.id,"*𖡦︙اهلا بك في بوت الحمايه \n𖡦︙وضيفتي حمايه المجموعات من السبام والتفليش والخ..\n𖡦︙لتفعيل البوت ارسل كلمه *تفعيل","md",true, false, false, false, kup)
end
end
end
end
...
if hash then    
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*𖡦︙"..tu.." "..ut.." من المجموعه*").yu,"md",true)  
end
end
Run(msg,data)
...
if #lsme == 0 then
t = "*𖡦︙لا يوجد مشرفين في المجموعه*"
end
bot.sendText(msg.chat_id,msg.id,t,"md", true)
end
end
